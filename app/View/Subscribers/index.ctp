<div class="subscribers index">
	...
	<tr>
		...
		<td><?php echo h($subscriber['Subscriber']['status']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $subscriber['Subscriber']['id']), array(), __('Are you sure you want to delete # %s?', $subscriber['Subscriber']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
