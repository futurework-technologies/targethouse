    ...
    <div class="contact_us">
    	<div class="container">
        	<div class="row"><div class="col-sm-12">
                            ...
                            <h1>Contact</h1>
                            <p>Get in touch with us and explore more about our products</p>
                         ...
                         <div class="contact_form">
                        	<div class="contact_form1">
                                <?php echo $this->Form->create('Conatct'); ?>
                                    ...
                                    <span class="col-sm-12"><textarea name="data[Contact][message]" cols="" placeholder="Message" rows="" required="true">Message...</textarea></span>
