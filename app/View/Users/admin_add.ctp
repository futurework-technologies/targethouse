...
<div class="content">
    <div class="header">
        ...
        <h1 class="page-title"> <?php echo __("Add Users")?></h1>
        <ul class="breadcrumb">
            <li class="active"><?php echo __("Add Users")?></li>
        </ul>
            ...
            <div class="col-md-4">
                <?php echo $this->Form->create('User',array('id'=>'tab','type'=>'file')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="data[User][password]" class="form-control span12" required>                        
                    </div>
                   <div class="form-group">
                        <label>Email</label>
                        <input type="email" name="data[User][email]" class="form-control span12" required>                        
                    </div>
                   <div class="form-group">
