<div class="container">
	...
	<div  class="content">
		...
		<div >
                      <?php echo $this->Form->create('User', array('action' => 'registe')); ?>
			<ul class="test" >
				<li>
				...
				<li>
                                       <span><label><?php echo __("First Name::")?></label>
                                        <input type="text" name="data[User][firstname]" class="form-control" value="" placeholder="firstname"/></span>
                                 
				</li>
				<li>
                                       <span><label><?php echo __("Sirname:")?></label>
                                        <input type="text" name="data[User][sirname]" class="form-control" value="" placeholder="sirname"/></span>
                                  
				</li>
				<li>
                                       <span><label><?php echo __("Company Name:")?></label>
                                        <input type="text" name="data[User][company_name]" class="form-control" value="" placeholder="company_name"/></span>
                                  
				</li>
				<li>
                                       <span><label><?php echo __("Addrese:")?></label>
                                        <input type="text" name="data[User][address]" class="form-control" value="" placeholder="address"/></span>
                                    
					
				</li>
				<li>
                                       <span><label><?php echo __("Postcode:")?></label>
                                        <input type="text" name="data[User][postcode]" class="form-control" value="" placeholder="postcode"/></span>
                                    
				</li>
				<li>
                                       <span><label><?php echo __("City:")?></label>
                                        <input type="text" name="data[User][city]" class="form-control" value="" placeholder="city"/></span>
                                    
				</li>
				<li>
                                       <span><label><?php echo __("Country:")?></label>
                                        <input type="text" name="data[User][country]" class="form-control" value="" placeholder="country"/></span>
				...
				<li>
                                       ...
                                       <span><label><?php echo __("Tel.No:")?></label>
                                        <input type="text" name="data[User][contact_no]" class="form-control" value="" placeholder="contact_no"/></span>
				
				</li>
				<li>
                                       <span><label><?php echo __("Fax No:")?></label>
                                        <input type="text" name="data[User][fax_no]" class="form-control" value="" placeholder="fax_no"/></span>
