<div class="subcategories index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($subcategory['Categories']['id'], array('controller' => 'categories', 'action' => 'view', $subcategory['Categories']['id'])); ?>
		</td>
		<td><?php echo h($subcategory['Subcategory']['name']); ?>&nbsp;</td>
		<td><?php echo h($subcategory['Subcategory']['timestamp']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $subcategory['Subcategory']['id']), array(), __('Are you sure you want to delete # %s?', $subcategory['Subcategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
