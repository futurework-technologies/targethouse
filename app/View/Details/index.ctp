<div class="details index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('detail1'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($detail['Detail']['article']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['size']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['color']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['price']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['detail1']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $detail['Detail']['id']), array(), __('Are you sure you want to delete # %s?', $detail['Detail']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
