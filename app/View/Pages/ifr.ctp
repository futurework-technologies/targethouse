<html>
    ...
    <head>
        ...
        echo $this->Html->script(array(
            ...
            '/svg/canvg/canvg',
            '/svg/jquery',
            '/svg/js-hotkeys/jquery.hotkeys.min',
            '/svg/jquerybbq/jquery.bbq.min',
            '/svg/svgicons/jquery.svgicons',
            '/svg/jgraduate/jquery.jgraduate.min',
            '/svg/spinbtn/JQuerySpinBtn.min',
            '/svg/touch',
            '/svg/svgedit.compiled',
//    'svg/edit',
//    'svg/jquery-svg',
//    'svg/contextmenu/jquery.contextMenu',
//    'svg/svgtransformlist',
//    'svg/math',
//    'svg/units',
//    'svg/svgutils',
//    'svg/sanitize',
...
//    'svg/contextmenu',
            //'/svg/config',
            '/svg/jquery-ui/jquery-ui-1.8.17.custom.min',
            '/svg/jgraduate/jpicker'
        ));
        ?>

        <?php
        echo $this->Html->css(array(
            '/svg/jgraduate/css/jPicker',
            '/svg/jgraduate/css/jgraduate',
            '/svg/svg-editor',
            '/svg/spinbtn/JQuerySpinBtn'
        ));
        ?>
...
//emptyStorageOnDecline: true
    ...
    imgPath: "/svg/images/",
    jGraduatePath: "/svg/jgraduate/images/",
    langPath: "/svg/locale/",
    extPath: "/svg/extensions/",
     dimensions: [<?php echo ($products['Product']['height']); ?>, <?php echo ($products['Product']['width']); ?>],
        canvas_expansion: 5,
        initFill: {
                color: '7f00ff'
        }
                ...
                <div id="rect_panel">
                    <div class="toolset">
                        <label id="rect_width_tool" title="Change rectangle width">
                            <a href="../../../../../../../../D:/Manoj/order html/sddd.html"></a>
...
if ($url != null) {
    ?>
                svgEditor.loadFromURL('<?php echo $url; ?>');

<?php } ?>
            });
            setTimeout(function(){
                svgEditor.canvas.setBackground("<?php echo ($products['Product']['back_color']); ?>");
                svgEditor.loadFromURL("<?php echo $this->Html->url('/files/logos/'.$products['Product']['product_image']); ?>");
            },5000);
            function getSVG(){
