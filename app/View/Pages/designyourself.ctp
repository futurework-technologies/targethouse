...
//emptyStorageOnDecline: true
    ...
    extPath: "/svg/extensions/",
     dimensions: [<?php echo ($products['Pdetail']['Height']); ?>, <?php echo ($products['Pdetail']['Width']); ?>],
        canvas_expansion: 5,
        initFill: {
                color: '7f00ff'
        }
...
<!--                    <p>
            ...
            <a href="../../../../../../../../D:/Manoj/New folder/svg-edit-2.7/svg-editor.html"></a>
...
<?php } ?>
            ...
            setTimeout(function(){
                svgEditor.canvas.setBackground("<?php echo ($products['Pdetail']['Color']); ?>");
            },5000);
            function getSVG(){
