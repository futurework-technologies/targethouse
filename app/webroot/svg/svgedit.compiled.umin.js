svgedit = {NS: {HTML: "http://www.w3.org/1999/xhtml", MATH: "http://www.w3.org/1998/Math/MathML", SE: "http://svg-edit.googlecode.com", SVG: "http://www.w3.org/2000/svg", XLINK: "http://www.w3.org/1999/xlink", XML: "http://www.w3.org/XML/1998/namespace", XMLNS: "http://www.w3.org/2000/xmlns/"}};
...
jQuery && function() {
    ...
    $.extend($.fn, {contextMenu: function(o, c) {
            if (o.menu == undefined)
                return false;
            ...
            if (o.outSpeed == 0)
                o.outSpeed = -1;
            $(this).each(function() {
                var i = $(this), s = $(i).offset(), e = $("#" + o.menu);
                    ...
                    $(this).mouseup(function(q) {
                        ...
                        if (g.button === 2 || o.allowLeft || g.ctrlKey && svgedit.browser.isMac()) {
                            ...
                            if (u > A - 30)
                                u = A - 30;
                            I.unbind("click");
                            e.css({top: u, left: D}).fadeIn(o.inSpeed);
                                ...
                                switch (p.keyCode) {
                                    case 38:
                                        if (e.find("LI.hover").length) {
                                            ...
                                            e.find("LI:last").addClass("hover");
                                        break;
                                    case 40:
                                        if (e.find("LI.hover").length == 0)
                                            e.find("LI:first").addClass("hover");
                                        else {
                            ...
                            e.find("LI:not(.disabled) A").mouseup(function() {
                                ...
                                $(".contextMenu").hide();
                                c && c($(this).attr("href").substr(1), $(w), {x: D - s.left, y: u - s.top, docX: D, docY: u});
                                return false
                            });
                            setTimeout(function() {
                                I.click(function() {
                ...
                if ($.browser.mozilla)
                    ...
                    $.browser.msie ? $("#" + o.menu).each(function() {
            ...
            $(this).each(function() {
                if (o != undefined)
                    for (var c = o.split(","), i = 0; i < c.length; i++)
                        $(this).find('A[href="' + c[i] + '"]').parent().addClass("disabled")
            });
            return $(this)
            ...
            $(this).each(function() {
                if (o !=
                        undefined)
                    for (var c = o.split(","), i = 0; i < c.length; i++)
                        $(this).find('A[href="' + c[i] + '"]').parent().removeClass("disabled")
            });
            return $(this)
...
(function() {
    if (!svgedit.browser)
        svgedit.browser = {};
    var a = svgedit.NS, I = !!document.createElementNS && !!document.createElementNS(a.SVG, "svg").createSVGRect;
    svgedit.browser.supportsSvg = function() {
        return I
    };
    if (svgedit.browser.supportsSvg()) {
        var o = navigator.userAgent, c = document.createElementNS(a.SVG, "svg"), i = !!window.opera, s = o.indexOf("AppleWebKit") >= 0, e = o.indexOf("Gecko/") >= 0, g = o.indexOf("MSIE") >= 0, q = o.indexOf("Chrome/") >= 0, w = o.indexOf("Windows") >= 0, D = o.indexOf("Macintosh") >= 0, u = "ontouchstart"in window,
                A = !!c.querySelector, p = !!document.evaluate, v = function() {
            ...
            var ea = document.createElementNS(a.SVG,
                    "svg"), ka = document.createElementNS(a.SVG, "svg");
            ...
            var ea = document.createElementNS(a.SVG, "rect").transform.baseVal, ka = c.createSVGTransform();
            ea.appendItem(ka);
...
(function() {
    ...
    var a = document.createElementNS(svgedit.NS.SVG, "svg"), I = {};
    svgedit.transformlist.SVGTransformList = function(o) {
        ...
        this._init = function() {
            ...
            if (c)
                for (var i = /\s*((scale|matrix|rotate|translate)\s*\(.*?\))\s*,?\s*/, s = true; s; ) {
                    ...
                    c = c.replace(i, "");
                    if (s && s[1]) {
                        var e = s[1].split(/\s*\(/), g = e[0];
                        e = e[1].match(/\s*(.*?)\s*\)/);
                        e[1] = e[1].replace(/(\d)-/g,
                                "$1 -");
                        var q = e[1].split(/[, ]+/), w = "abcdef".split(""), D = a.createSVGMatrix();
                        $.each(q, function(p, v) {
                            q[p] = parseFloat(v);
                            if (g == "matrix")
                                D[w[p]] = q[p]
                        ...
                        var u = "set" + g.charAt(0).toUpperCase() + g.slice(1), A = g == "matrix" ? [D] : q;
                        if (g == "scale" && A.length == 1)
                            A.push(A[0]);
                        else if (g == "translate" && A.length == 1)
                            A.push(0);
                        else
                            g == "rotate" && A.length == 1 && A.push(0, 0);
                        e[u].apply(e, A);
        ...
        this.insertItemBefore = function(c, i) {
            ...
            if (i >= 0)
                if (i < this.numberOfItems) {
                    ...
                    s[e] = c;
                    var g;
                    for (g = e + 1; e < this.numberOfItems; ++g, ++e)
                        s[g] = this._xforms[e];
                    this.numberOfItems++;
                    this._xforms = s;
                    s = c;
        ...
        this.removeItem = function(c) {
            if (c < this.numberOfItems && c >= 0) {
                var i = this._xforms[c], s = Array(this.numberOfItems - 1), e;
                for (e = 0; e < c; ++e)
                    s[e] =
                            this._xforms[e];
                for (c = e; c < this.numberOfItems - 1; ++c, ++e)
                    s[c] = this._xforms[e + 1];
                this.numberOfItems--;
                this._xforms = s;
                this._list._update();
                return i
    ...
    svgedit.transformlist.getTransformList = function(o) {
        ...
        if (o.transform)
            return o.transform.baseVal;
        if (o.gradientTransform)
            return o.gradientTransform.baseVal;
        if (o.patternTransform)
            return o.patternTransform.baseVal;
        return null
    }
})();
(function() {
    ...
    svgedit.math.transformPoint = function(I, o, c) {
        return{x: c.a * I + c.c * o + c.e, y: c.b * I + c.d * o + c.f}
    };
    svgedit.math.isIdentity = function(I) {
        return I.a === 1 && I.b === 0 && I.c === 0 && I.d === 1 && I.e === 0 && I.f === 0
    };
    svgedit.math.matrixMultiply = function() {
        for (var I = arguments, o = I.length, c = I[o - 1]; o-- > 1; )
            c = I[o - 1].multiply(c);
        if (Math.abs(c.a) < 1.0E-14)
            c.a = 0;
        if (Math.abs(c.b) < 1.0E-14)
            c.b = 0;
        if (Math.abs(c.c) < 1.0E-14)
            c.c = 0;
        if (Math.abs(c.d) <
                1.0E-14)
            c.d = 0;
        if (Math.abs(c.e) < 1.0E-14)
            c.e = 0;
        if (Math.abs(c.f) < 1.0E-14)
            c.f = 0;
        return c
    };
    svgedit.math.hasMatrixTransform = function(I) {
        ...
        for (var o = I.numberOfItems; o--; ) {
            var c = I.getItem(o);
            if (c.type == 1 && !svgedit.math.isIdentity(c.matrix))
                return true
        }
        return false
    };
    svgedit.math.transformBox = function(I, o, c, i, s) {
        var e = svgedit.math.transformPoint, g = e(I, o, s), q = e(I + c, o, s), w = e(I, o + i, s);
        I = e(I + c, o + i, s);
        o = Math.min(g.x, q.x, w.x, I.x);
        c = Math.min(g.y, q.y, w.y, I.y);
        return{tl: g, tr: q, bl: w, br: I, aabox: {x: o,
                y: c, width: Math.max(g.x, q.x, w.x, I.x) - o, height: Math.max(g.y, q.y, w.y, I.y) - c}}
    };
    svgedit.math.transformListToTransform = function(I, o, c) {
        if (I == null)
            return a.createSVGTransformFromMatrix(a.createSVGMatrix());
        o = o || 0;
    ...
    svgedit.math.snapToAngle = function(I, o, c, i) {
        ...
        return{x: I + i * Math.cos(s), y: o + i * Math.sin(s), a: s}
    };
...
(function() {
    if (!svgedit.units)
        svgedit.units = {};
    var a = svgedit.NS, I = ["x", "x1", "cx", "rx", "width"], o = ["y", "y1", "cy", "ry", "height"], c = ["r", "radius"].concat(I, o), i, s = {};
    svgedit.units.init = function(g) {
        ...
        g = q.x;
        s = {em: q.width, ex: q.height, "in": g, cm: g /
            2.54, mm: g / 25.4, pt: g / 72, pc: g / 6, px: 1, "%": 0}
    };
    ...
    svgedit.units.shortFloat = function(g) {
        ...
        if (!isNaN(g))
            return+(+g).toFixed(q);
        if ($.isArray(g))
            return svgedit.units.shortFloat(g[0]) + "," + svgedit.units.shortFloat(g[1]);
    ...
    var e = {line: ["x1", "x2", "y1",
            "y2"], circle: ["cx", "cy", "r"], ellipse: ["cx", "cy", "rx", "ry"], foreignObject: ["x", "y", "width", "height"], rect: ["x", "y", "width", "height"], image: ["x", "y", "width", "height"], use: ["x", "y", "width", "height"], text: ["x", "y"]};
    svgedit.units.convertAttrs = function(g) {
        var q = g.tagName, w = i.getBaseUnit();
        if (q = e[q]) {
            var D = q.length, u;
            for (u = 0; u < D; u++) {
                var A = q[u], p = g.getAttribute(A);
                if (p)
                    isNaN(p) || g.setAttribute(A, p / s[w] + w)
            }
        }
    };
    svgedit.units.convertToNum = function(g, q) {
        ...
        if (q.substr(-1) === "%") {
            ...
            var D = i.getWidth(), u = i.getHeight();
            if (I.indexOf(g) >= 0)
                return w * D;
            if (o.indexOf(g) >= 0)
                return w * u;
...
(function() {
    ...
    if (!svgedit.utilities)
        svgedit.utilities =
                {};
    var I = svgedit.NS, o = "a,circle,ellipse,foreignObject,g,image,line,path,polygon,polyline,rect,svg,text,tspan,use".split(","), c = null, i = null, s = null, e = null;
    ...
    svgedit.utilities.encode64 =
            function(g) {
                ...
                var q = Array(Math.floor((g.length + 2) / 3) * 4), w, D, u, A, p, v, t = 0, m = 0;
                do {
                    w = g.charCodeAt(t++);
                    D = g.charCodeAt(t++);
                    u = g.charCodeAt(t++);
    ...
    svgedit.utilities.encodeUTF8 = function(g) {
        ...
        var A;
        for (A = 0; A < u; A++) {
            var p = g.charCodeAt(A), v = null;
            if (p < 128)
                D++;
            else if (p > 127 && p < 2048)
                v = String.fromCharCode(p >>
                        6 | 192, p & 63 | 128);
            else if ((p & 63488) != 55296)
                v = String.fromCharCode(p >> 12 | 224, p >> 6 & 63 | 128, p & 63 | 128);
            else {
                if ((p & 64512) != 55296)
    ...
    svgedit.utilities.text2xml = function(g) {
        if (g.indexOf("<svg:svg") >= 0)
            g = g.replace(/<(\/?)svg:/g, "<$1").replace("xmlns:svg", "xmlns");
        var q, w;
        try {
    ...
    svgedit.utilities.walkTree = function(g, q) {
        if (g && g.nodeType == 1) {
            q(g);
            for (var w = g.childNodes.length; w--; )
                svgedit.utilities.walkTree(g.childNodes.item(w), q)
        }
    };
        ...
        if (g) {
            if (g.indexOf('url("') === 0)
                return g.substring(5,
                        g.indexOf('"', 6));
            if (g.indexOf("url('") === 0)
                return g.substring(5, g.indexOf("'", 6));
            if (g.indexOf("url(") === 0)
                return g.substring(4, g.indexOf(")"))
        }
        return null
    };
    ...
    svgedit.utilities.findDefs = function() {
        var g = c.getSVGContent(), q = g.getElementsByTagNameNS(I.SVG, "defs");
        if (q.length > 0)
            q = q[0];
        else {
    ...
    svgedit.utilities.getPathBBox = function(g) {
        var q = g.pathSegList, w = q.numberOfItems;
        g = [[], []];
        var D = q.getItem(0), u = [D.x, D.y];
        for (D = 0; D < w; D++) {
            var A = q.getItem(D);
        ...
        return{x: q, y: D, width: w, height: g}
    };
    svgedit.utilities.getBBox = function(g) {
        ...
        switch (w) {
            ...
            case "path":
                if (svgedit.browser.supportsPathBBox())
                    ...
                    g = svgedit.utilities.getPathBBox(q);
                break;
            case "g":
            case "a":
                g = a(q);
        ...
        if (g)
            g = svgedit.utilities.bboxToObj(g);
        return g
    };
    svgedit.utilities.getRotationAngle = function(g, q) {
        ...
        if (!w)
            return 0;
        var D = w.numberOfItems, u;
        for (u = 0; u < D; ++u) {
            var A = w.getItem(u);
            if (A.type == 4)
                return q ? A.angle * Math.PI / 180 : A.angle
        }
        return 0
    };
    ...
    svgedit.utilities.assignAttributes = function(g, q, w, D) {
        ...
        for (var u in q)
            if (w = u.substr(0, 4) === "xml:" ? I.XML : u.substr(0, 6) === "xlink:" ? I.XLINK : null)
                g.setAttributeNS(w, u, q[u]);
            else
                D ? svgedit.units.setUnitAttr(g, u, q[u]) : g.setAttribute(u, q[u]);
        svgedit.browser.isOpera() || e.unsuspendRedraw(null)
    };
    svgedit.utilities.cleanupElement = function(g) {
        var q = e.suspendRedraw(60), w = {"fill-opacity": 1, "stop-opacity": 1, opacity: 1, stroke: "none", "stroke-dasharray": "none", "stroke-linejoin": "miter",
            "stroke-linecap": "butt", "stroke-opacity": 1, "stroke-width": 1, rx: 0, ry: 0}, D;
        for (D in w) {
            var u = w[D];
    ...
    svgedit.utilities.snapToGrid = function(g) {
        var q = c.getSnappingStep(), w = c.getBaseUnit();
        if (w !== "px")
            q *= svgedit.units.getTypeMap()[w];
...
(function() {
    ...
    var a = svgedit.NS, I = svgedit.getReverseNS(), o = {a: ["class", "clip-path", "clip-rule", "fill", "fill-opacity", "fill-rule", "filter", "id", "mask", "opacity", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "style", "systemLanguage", "transform", "xlink:href", "xlink:title"], circle: ["class", "clip-path", "clip-rule", "cx", "cy", "fill", "fill-opacity", "fill-rule", "filter", "id", "mask",
        ...
        mo: ["fence", "lspace", "maxsize", "minsize", "rspace", "stretchy"], mover: [], mpadded: ["lspace", "width", "height", "depth", "voffset"], mphantom: [], mprescripts: [], mroot: [], mrow: ["xlink:href", "xlink:type", "xmlns:xlink"], mspace: ["depth", "height", "width"], msqrt: [], mstyle: ["displaystyle", "mathbackground", "mathcolor", "mathvariant", "scriptlevel"], msub: [], msubsup: [], msup: [], mtable: ["align", "columnalign", "columnlines", "columnspacing", "displaystyle", "equalcolumns", "equalrows", "frame", "rowalign", "rowlines", "rowspacing",
            "width"], mtd: ["columnalign", "columnspan", "rowalign", "rowspan"], mtext: [], mtr: ["columnalign", "rowalign"], munder: [], munderover: [], none: [], semantics: []}, c = {};
    $.each(o, function(i, s) {
        var e = {};
        $.each(s, function(g, q) {
            if (q.indexOf(":") >= 0) {
    ...
    svgedit.sanitize.sanitizeSvg = function(i) {
        ...
        if (i.nodeType == 1) {
            ...
            if (i.ownerDocument && s) {
                var e = o[i.nodeName], g = c[i.nodeName], q;
                if (typeof e !== "undefined") {
                    ...
                    if (i.nodeName == "use" && !svgedit.utilities.getHref(i))
                        s.removeChild(i);
                    else {
                        ...
                        for (q = i.childNodes.length; q--; )
                            svgedit.sanitize.sanitizeSvg(i.childNodes.item(q))
                    }
                } else {
                    for (e = []; i.hasChildNodes(); )
                        e.push(s.insertBefore(i.firstChild, i));
                    s.removeChild(i);
                    for (q = e.length; q--; )
                        svgedit.sanitize.sanitizeSvg(e[q])
                }
            }
        }
    }
...
(function() {
    ...
    svgedit.history.ChangeElementCommand = function(a, I, o) {
        ...
        this.oldValues = I;
        for (var c in I)
            this.newValues[c] = c == "#text" ? a.textContent : c == "#href" ? svgedit.utilities.getHref(a) : a.getAttribute(c)
    };
    ...
    svgedit.history.ChangeElementCommand.prototype.apply = function(a) {
        ...
        for (o in this.newValues) {
            if (this.newValues[o])
                if (o == "#text")
                    this.elem.textContent = this.newValues[o];
                else
                    o == "#href" ?
    ...
    svgedit.history.ChangeElementCommand.prototype.unapply = function(a) {
        ...
        for (o in this.oldValues) {
            if (this.oldValues[o])
                if (o == "#text")
                    this.elem.textContent = this.oldValues[o];
                else
                    o == "#href" ? svgedit.utilities.setHref(this.elem, this.oldValues[o]) : this.elem.setAttribute(o, this.oldValues[o]);
            else if (o == "#text")
                this.elem.textContent = "";
            else
                this.elem.removeAttribute(o);
    ...
    svgedit.history.BatchCommand.prototype.unapply = function(a) {
        ...
        for (I = this.stack.length - 1; I >= 0; I--)
            this.stack[I].unapply(a);
        a && a.handleHistoryEvent(svgedit.history.HistoryEventTypes.AFTER_UNAPPLY, this)
    };
    svgedit.history.BatchCommand.prototype.elements = function() {
        for (var a = [], I = this.stack.length; I--; )
            for (var o = this.stack[I].elements(), c = o.length; c--; )
                a.indexOf(o[c]) == -1 && a.push(o[c]);
        return a
    };
    ...
    svgedit.history.UndoManager.prototype.beginUndoableChange =
            function(a, I) {
                ...
                this.undoableChangeStack[o] = {attrName: a, oldValues: i, elements: s}
            };
...
(function() {
    if (!svgedit.coords)
        svgedit.coords = {};
    var a = [0, "z", "M", "m", "L", "l", "C", "c", "Q", "q", "A", "a", "H", "h", "V", "v", "S", "s", "T", "t"], I = null;
    ...
    svgedit.coords.remapElement = function(o, c, i) {
        ...
        }, q = I.getGridSnapping() && o.parentNode.parentNode.localName === "svg", w = function() {
            var v;
            if (q)
                for (v in c)
                    c[v] = svgedit.utilities.snapToGrid(c[v]);
        ...
        for (s = 0; s < 2; s++) {
            ...
            if (u && u.indexOf("url(") === 0)
                if (i.a < 0 || i.d < 0) {
                    ...
                    if (i.a < 0) {
                        var A = u.getAttribute("x1"), p = u.getAttribute("x2");
        ...
        switch (s) {
            ...
            case "path":
                ...
                for (s = 0; s < w; ++s) {
                    D = e.getItem(s);
                    c.d[s] = {type: D.pathSegType, x: D.x, y: D.y, x1: D.x1, y1: D.y1, x2: D.x2, y2: D.y2, r1: D.r1, r2: D.r2, angle: D.angle, largeArcFlag: D.largeArcFlag, sweepFlag: D.sweepFlag}
                }
                w = c.d.length;
                s = c.d[0];
                p = g(s.x, s.y);
...
(function() {
    ...
    svgedit.recalculate.updateClipPath = function(o, c, i) {
        ...
        var s = svgedit.transformlist.getTransformList(o), e = I.getSVGRoot().createSVGTransform();
        e.setTranslate(c, i);
        s.appendItem(e);
    ...
    svgedit.recalculate.recalculateDimensions = function(o) {
        if (o == null)
            return null;
        if (o.nodeName == "svg" && navigator.userAgent.indexOf("Firefox/20") >= 0)
            return null;
        var c = I.getSVGRoot(), i = svgedit.transformlist.getTransformList(o), s;
        if (i && i.numberOfItems > 0) {
            for (s = i.numberOfItems; s--; ) {
                ...
                if (e.type === 0)
                    ...
                    svgedit.math.isIdentity(e.matrix) && i.removeItem(s);
                else
                    e.type === 4 && e.angle === 0 && i.removeItem(s)
            }
            if (i.numberOfItems === 1 && svgedit.utilities.getRotationAngle(o))
                return null
        }
        if (!i || i.numberOfItems == 0) {
        ...
        switch (o.tagName) {
            ...
            case "path":
                break;
            default:
                if (i.numberOfItems === 1 && i.getItem(0).type === 1 || i.numberOfItems === 2 && i.getItem(0).type === 1 && i.getItem(0).type === 4)
                    return null
        }
        var q = $(o).data("gsvg");
        ...
        if (o.tagName == "g" && !q || o.tagName == "a") {
            ...
            var v = {x: g.x + g.width / 2, y: g.y + g.height / 2}, t = svgedit.math.transformPoint(g.x + g.width / 2, g.y + g.height / 2, svgedit.math.transformListToTransform(i).matrix);
            e = c.createSVGMatrix();
            ...
            if (m)
                var L = i.getItem(0).matrix;
            if (m >= 3 && i.getItem(m - 2).type == 3 && i.getItem(m - 3).type == 2 && i.getItem(m - 1).type == 2) {
                A = 3;
                var R = i.getItem(m - 3).matrix, da = i.getItem(m - 2).matrix, qa = i.getItem(m - 1).matrix;
                u = o.childNodes;
                for (p = u.length; p--; ) {
                    var fa = u.item(p);
                    e = q = 0;
                    if (fa.nodeType == 1) {
                        ...
                        if (ea) {
                            ...
                            if (q || svgedit.math.hasMatrixTransform(ea)) {
                                ...
                                var Lb = c.createSVGTransform(), kb = c.createSVGTransform(), ib = c.createSVGTransform();
            ...
            if (A == 2) {
                ...
                if (g)
                    i.numberOfItems ? i.insertItemBefore(v, 0) : i.appendItem(v)
            }
        } else {
            g = svgedit.utilities.getBBox(o);
            if (!g && o.tagName != "path")
            ...
            if (q = svgedit.utilities.getRotationAngle(o)) {
                v = {x: g.x + g.width / 2, y: g.y + g.height / 2};
            ...
            if (A == 1 || A == 2 || A == 3)
                svgedit.coords.remapElement(o, w, e);
            if (A == 2) {
                if (q) {
                    svgedit.math.hasMatrixTransform(i) || (t = {x: v.x + e.e, y: v.y + e.f});
                    c = c.createSVGTransform();
                    c.setRotate(q, t.x, t.y);
                    i.numberOfItems ? i.insertItemBefore(c, 0) : i.appendItem(c)
                }
...
(function() {
    ...
    svgedit.select.Selector = function(i, s) {
        ...
        this.selectorRect = this.selectorGroup.appendChild(a.createSVGElement({element: "path", attr: {id: "selectedBox" + this.id, fill: "none", stroke: "#22C", "stroke-width": "1", "stroke-dasharray": "5,5", style: "pointer-events:none"}}));
        this.gripCoords = {nw: null,
            n: null, ne: null, e: null, se: null, s: null, sw: null, w: null};
    ...
    svgedit.select.Selector.prototype.resize = function() {
        var i = this.selectorRect, s = o, e = s.selectorGrips, g = this.selectedElement, q = g.getAttribute("stroke-width"), w = a.currentZoom(), D = 1 / w;
        ...
        if (u === "g" && !$.data(g, "gsvg"))
            if (u = a.getStrokedBBox(g.childNodes))
                A = u;
        u = A.x;
        var p = A.y, v = A.width;
        A = A.height;
        ...
        this.gripCoords = {nw: [u, p], ne: [u + v, p], sw: [u, p + t], se: [u + v, p + t], n: [u + v / 2, p], w: [u, p + t / 2], e: [u + v, p + t / 2], s: [u + v / 2, p + t]};
    ...
    svgedit.select.SelectorManager.prototype.initGroup =
            function() {
                ...
                for (var i in this.selectorGrips) {
                    var s =
                            a.createSVGElement({element: "circle", attr: {id: "selectorGrip_resize_" + i, fill: "#22C", r: c, style: "cursor:" + i + "-resize", "stroke-width": 2, "pointer-events": "all"}});
                    $.data(s, "dir", i);
                    $.data(s, "type", "resize");
                    this.selectorGrips[i] = this.selectorGripsGroup.appendChild(s)
                }
                this.rotateGripConnector = this.selectorGripsGroup.appendChild(a.createSVGElement({element: "line", attr: {id: "selectorGrip_rotateconnector", stroke: "#22C", "stroke-width": "1"}}));
                this.rotateGrip = this.selectorGripsGroup.appendChild(a.createSVGElement({element: "circle",
                    attr: {id: "selectorGrip_rotate", fill: "lime", r: c, stroke: "#22C", "stroke-width": 2, style: "cursor:url(" + I.imgPath + "rotate.png) 12 12, auto;"}}));
                $.data(this.rotateGrip, "type", "rotate");
                if (!$("#canvasBackground").length) {
                    i = I.dimensions;
                    i = a.createSVGElement({element: "svg", attr: {id: "canvasBackground", width: i[0], height: i[1], x: 0, y: 0, overflow: svgedit.browser.isWebkit() ? "none" : "visible", style: "pointer-events:none"}});
                    s = a.createSVGElement({element: "rect", attr: {width: "100%", height: "100%", x: 0, y: 0, "stroke-width": 1,
                            stroke: "#000", fill: "#FFF", style: "pointer-events:none"}});
                    i.appendChild(s);
    ...
    svgedit.select.SelectorManager.prototype.releaseSelector = function(i) {
        if (i != null) {
            var s, e = this.selectors.length, g = this.selectorMap[i.id];
            for (s = 0; s < e; ++s)
    ...
    svgedit.select.SelectorManager.prototype.getRubberBandBox = function() {
        if (!this.rubberBandBox)
            this.rubberBandBox = this.selectorParentGroup.appendChild(a.createSVGElement({element: "rect", attr: {id: "selectorRubberBand", fill: "#22C", "fill-opacity": 0.15, stroke: "#22C", "stroke-width": 0.5, display: "none", style: "pointer-events:none"}}));
...
(function() {
    if (!svgedit.draw)
        svgedit.draw = {};
    var a = svgedit.NS, I = "a,circle,ellipse,foreignObject,g,image,line,path,polygon,polyline,rect,svg,text,tspan,use".split(","), o = {LET_DOCUMENT_DECIDE: 0, ALWAYS_RANDOMIZE: 1, NEVER_RANDOMIZE: 2}, c = o.LET_DOCUMENT_DECIDE;
    ...
    svgedit.draw.randomizeIds = function(i, s) {
        ...
        if (c == o.ALWAYS_RANDOMIZE && !s.getNonce())
            s.setNonce(Math.floor(Math.random() * 100001));
        else
            c == o.NEVER_RANDOMIZE && s.getNonce() && s.clearNonce()
    };
    svgedit.draw.Drawing = function(i, s) {
        if (!i || !i.tagName || !i.namespaceURI || i.tagName != "svg" || i.namespaceURI != a.SVG)
        ...
        if (e && c != o.NEVER_RANDOMIZE)
            this.nonce_ = e;
        else
            c == o.ALWAYS_RANDOMIZE && this.setNonce(Math.floor(Math.random() * 100001))
    };
    svgedit.draw.Drawing.prototype.getElem_ = function(i) {
        if (this.svgElem_.querySelector)
            return this.svgElem_.querySelector("#" + i);
    ...
    svgedit.draw.Drawing.prototype.releaseId = function(i) {
        ...
        if (typeof i !== "number" || i <= 0 || this.releasedNums.indexOf(i) != -1)
            return false;
    ...
    svgedit.draw.Drawing.prototype.identifyLayers = function() {
        this.all_layers = [];
        var i = this.svgElem_.childNodes.length, s = [], e = [], g = null, q = false, w;
        for (w = 0; w < i; ++w) {
            ...
            if (D && D.nodeType == 1)
                if (D.tagName == "g") {
                    q = true;
                    var u = $("title", D).text();
                    if (!u && svgedit.browser.isOpera() && D.querySelectorAll)
                        u = $(D.querySelectorAll("title")).text();
                    if (u) {
                        e.push(u);
    ...
    svgedit.draw.Drawing.prototype.createLayer = function(i) {
        var s = this.svgElem_.ownerDocument, e = s.createElementNS(a.SVG, "g");
...
(function() {
    if (!svgedit.path)
        svgedit.path = {};
    var a = svgedit.NS, I = {pathNodeTooltip: "Drag node to move it. Double-click node to change segment type", pathCtrlPtTooltip: "Drag control point to adjust curve properties"}, o = {2: ["x", "y"], 4: ["x", "y"], 6: ["x", "y", "x1", "y1", "x2", "y2"], 8: ["x", "y", "x1", "y1"], 10: ["x", "y", "r1", "r2", "angle", "largeArcFlag", "sweepFlag"], 12: ["x"], 14: ["y"], 16: ["x", "y", "x2", "y2"], 18: ["x", "y"]}, c = [], i = true, s = {};
    ...
    svgedit.path.insertItemBefore = function(p, v, t) {
        ...
        if (svgedit.browser.supportsPathInsertItemBefore())
            p.insertItemBefore(v, t);
        else {
            var m = p.numberOfItems, L = [], R;
            for (R = 0; R < m; R++) {
                var da = p.getItem(R);
                L.push(da)
            }
    ...
    svgedit.path.ptObjToArr = function(p, v) {
        var t = o[p], m = t.length, L, R = [];
        for (L = 0; L < m; L++)
            R[L] = v[t[L]];
        return R
    };
    svgedit.path.getGripPt = function(p, v) {
        var t = {x: v ? v.x : p.item.x, y: v ? v.y : p.item.y}, m = p.path;
        if (m.matrix)
            t = svgedit.math.transformPoint(t.x, t.y, m.matrix);
    ...
    svgedit.path.addPointGrip = function(p, v, t) {
        var m = svgedit.path.getGripContainer(), L = svgedit.utilities.getElem("pathpointgrip_" + p);
        if (!L) {
            L = document.createElementNS(a.SVG, "circle");
            svgedit.utilities.assignAttributes(L, {id: "pathpointgrip_" + p, display: "none", r: 4, fill: "#0FF", stroke: "#00F", "stroke-width": 2, cursor: "move", style: "pointer-events:all", "xlink:title": I.pathNodeTooltip});
            L = m.appendChild(L);
        ...
        v &&
                t && svgedit.utilities.assignAttributes(L, {cx: v, cy: t, display: "inline"});
        return L
    };
    ...
    svgedit.path.addCtrlGrip = function(p) {
        ...
        svgedit.utilities.assignAttributes(v,
                {id: "ctrlpointgrip_" + p, display: "none", r: 4, fill: "#0FF", stroke: "#55F", "stroke-width": 1, cursor: "move", style: "pointer-events:all", "xlink:title": I.pathCtrlPtTooltip});
    ...
    svgedit.path.getCtrlLine = function(p) {
        ...
        svgedit.utilities.assignAttributes(v, {id: "ctrlLine_" + p, stroke: "#555", "stroke-width": 1, style: "pointer-events:none"});
        svgedit.path.getGripContainer().appendChild(v);
        return v
    };
    svgedit.path.getPointGrip = function(p, v) {
        ...
        if (v) {
            ...
            svgedit.utilities.assignAttributes(t, {cx: m.x, cy: m.y, display: "inline"})
        }
        return t
    };
    svgedit.path.getControlPoints = function(p) {
        var v = p.item, t = p.index;
        if (!("x1"in v) || !("x2"in v))
            return null;
        var m = {};
        svgedit.path.getGripContainer();
        var L = [svgedit.path.path.segs[t - 1].item, v], R;
        for (R = 1; R < 3; R++) {
            var da = t + "c" + R, qa = m["c" + R + "_line"] = svgedit.path.getCtrlLine(da), fa = svgedit.path.getGripPt(p,
                    {x: v["x" + R], y: v["y" + R]}), ea = svgedit.path.getGripPt(p, {x: L[R - 1].x, y: L[R - 1].y});
            svgedit.utilities.assignAttributes(qa, {x1: fa.x, y1: fa.y, x2: ea.x, y2: ea.y, display: "inline"});
            m["c" + R + "_line"] = qa;
            da = m["c" + R] = svgedit.path.addCtrlGrip(da);
            svgedit.utilities.assignAttributes(da, {cx: fa.x, cy: fa.y, display: "inline"});
            m["c" + R] = da
        }
        return m
    };
    svgedit.path.replacePathSeg = function(p, v, t, m) {
        ...
        if (svgedit.browser.supportsPathReplaceItem())
            ...
            t.clear();
            for (R = 0; R < m; R++)
                R == v ? t.appendItem(p) : t.appendItem(L[R])
        }
    };
    svgedit.path.getSegSelector = function(p, v) {
        var t = p.index, m = svgedit.utilities.getElem("segline_" + t);
        if (!m) {
            var L = svgedit.path.getGripContainer();
            m = document.createElementNS(a.SVG, "path");
            svgedit.utilities.assignAttributes(m, {id: "segline_" + t, display: "none", fill: "none", stroke: "#0FF", "stroke-width": 2, style: "pointer-events:none", d: "M0,0 0,0"});
            L.appendChild(m)
        }
        if (v) {
            t = p.prev;
            ...
            for (R = 0; R < L.length; R += 2) {
                t = svgedit.path.getGripPt(p, {x: L[R], y: L[R + 1]});
                L[R] = t.x;
                L[R + 1] = t.y
            }
    ...
    svgedit.path.smoothControlPoints = function(p, v, t) {
        var m = p.x - t.x, L = p.y - t.y, R = v.x - t.x, da = v.y - t.y;
        if ((m != 0 || L != 0) && (R != 0 || da != 0)) {
            p = Math.atan2(L, m);
            v = Math.atan2(da,
                    R);
            ...
            if (v < 0)
                v += 2 * Math.PI;
            var qa = Math.abs(p - v), fa = Math.abs(Math.PI - qa) / 2;
            if (p - v > 0) {
    ...
    svgedit.path.Segment.prototype.showCtrlPts = function(p) {
        for (var v in this.ctrlpts)
            if (this.ctrlpts.hasOwnProperty(v))
                this.ctrlpts[v].setAttribute("display", p ? "inline" : "none")
    };
    ...
    svgedit.path.Segment.prototype.update = function(p) {
        if (this.ptgrip) {
            ...
            svgedit.utilities.assignAttributes(this.ptgrip, {cx: v.x, cy: v.y});
    ...
    svgedit.path.Path.prototype.init = function() {
        ...
        var p = this.elem.pathSegList, v = p.numberOfItems;
        this.segs = [];
        this.selected_pts = [];
        this.first_seg = null;
        var t;
        ...
        m = null;
        for (t = 0; t < v; t++) {
            var L = p[t], R = t + 1 >= v ? null : p[t + 1], da = t - 1 < 0 ? null : p[t - 1];
            if (L.type === 2) {
                if (da && da.type !== 1) {
                    R = p[m];
                    R.next = p[m + 1];
        ...
        if (v.prev) {
            ...
            switch (v.item.pathSegType) {
                ...
                case 6:
                    ...
                    var da = (v.item.x1 + v.item.x2) / 2, qa = (v.item.x2 + v.item.x) / 2, fa = (m + da) / 2;
                    da = (da + qa) / 2;
                    L = (fa + da) / 2;
                    var ea = (t.item.y + v.item.y1) / 2, ka = (v.item.y1 + v.item.y2) / 2;
    ...
    svgedit.path.Path.prototype.movePts = function(p, v) {
        for (var t = this.selected_pts.length; t--; )
            this.segs[this.selected_pts[t]].move(p, v)
    };
    ...
    svgedit.path.Path.prototype.setSegType = function(p) {
        ...
        for (var v = this.selected_pts.length, t; v--; ) {
            var m = this.segs[this.selected_pts[v]], L = m.prev;
            if (L) {
                if (!p) {
                ...
                p = Number(p);
                var R = m.item.x, da = m.item.y, qa = L.item.x;
                L = L.item.y;
                var fa;
                switch (p) {
                    case 6:
    ...
    var g, q, w, D, u, A = function(p, v) {
        var t = p - w, m = v - D, L = Math.sqrt(t * t + m * m);
        m = Math.atan2(m,
                t) + u;
        t = L * Math.cos(m) + w;
        m = L * Math.sin(m) + D;
...
$.SvgCanvas = function(a, I) {
    function o(b, f) {
        ...
        for (d = 0; d < 2; d++) {
            var j = d === 0 ? "fill" : "stroke", E = b.getAttribute(j);
            if (E && E.indexOf("url(") === 0) {
                E = svgedit.utilities.getRefElem(E);
                if (E.tagName === "linearGradient") {
                    var n = E.getAttribute("x1") || 0, z = E.getAttribute("y1") || 0, B = E.getAttribute("x2") || 1, G = E.getAttribute("y2") || 0;
                    n = r.width * n + r.x;
                    z = r.height * z + r.y;
                    B = r.width * B + r.x;
                    G = r.height * G + r.y;
    ...
    var c = svgedit.NS, i = {show_outside_canvas: true, selectNew: true, dimensions: [640, 480]};
    I && $.extend(i, I);
    var s = i.dimensions, e = this, g = a.ownerDocument, q = g.importNode(svgedit.utilities.text2xml('<svg id="svgroot" xmlns="' + c.SVG + '" xlinkns="' + c.XLINK + '" width="' + s[0] + '" height="' + s[1] + '" x="' + s[0] + '" y="' +
    ...
    (e.clearSvgContentElement = function() {
        ...
        $(w).attr({id: "svgcontent",
            width: s[0], height: s[1], x: s[0], y: s[1], overflow: i.show_outside_canvas ? "visible" : "hidden", xmlns: c.SVG, "xmlns:se": c.SE, "xmlns:xlink": c.XLINK}).appendTo(q);
    ...
    }, A = 1, p = null, v = {shape: {fill: (i.initFill.color == "none" ? "" : "#") + i.initFill.color, fill_paint: null,
            fill_opacity: i.initFill.opacity, stroke: "#" + i.initStroke.color, stroke_paint: null, stroke_opacity: i.initStroke.opacity, stroke_width: i.initStroke.width, stroke_dasharray: "none", stroke_linejoin: "miter", stroke_linecap: "butt", opacity: i.initOpacity}};
    v.text = $.extend(true, {}, v.shape);
    $.extend(v.text, {fill: "#000000", stroke_width: 0, font_size: 24, font_family: "serif"});
    var t = v.shape, m = Array(1), L = this.addSvgElementFromJson = function(b) {
        var f = svgedit.utilities.getElem(b.attr.id), d = u().getCurrentLayer();
        if (f && b.element !=
                f.tagName) {
            d.removeChild(f);
            f = null
        ...
        b.curStyles && svgedit.utilities.assignAttributes(f, {fill: t.fill, stroke: t.stroke, "stroke-width": t.stroke_width, "stroke-dasharray": t.stroke_dasharray, "stroke-linejoin": t.stroke_linejoin, "stroke-linecap": t.stroke_linecap, "stroke-opacity": t.stroke_opacity, "fill-opacity": t.fill_opacity, opacity: t.opacity / 2, style: "pointer-events:inherit"}, 100);
    ...
    var R = svgedit.math.transformPoint, da = e.matrixMultiply = svgedit.math.matrixMultiply, qa = e.hasMatrixTransform = svgedit.math.hasMatrixTransform, fa = e.transformListToTransform = svgedit.math.transformListToTransform;
    ...
    var ea = e.findDefs = svgedit.utilities.findDefs, ka = e.getUrlFromAttr = svgedit.utilities.getUrlFromAttr, Ia = e.getHref = svgedit.utilities.getHref, Ba = e.setHref = svgedit.utilities.setHref,
    ...
    var ib = e.assignAttributes = svgedit.utilities.assignAttributes, ta = this.cleanupElement = svgedit.utilities.cleanupElement;
    ...
    e.undoMgr = new svgedit.history.UndoManager({handleHistoryEvent: function(b, f) {
            ...
            if (b == d.BEFORE_UNAPPLY || b == d.BEFORE_APPLY)
                ...
                d = b == d.AFTER_APPLY;
                if (r == Ab.type())
                    (d ? f.newParent : f.oldParent) == w && e.identifyLayers();
    ...
    svgedit.select.init(i, {createSVGElement: function(b) {
    ...
    var qb = {exportNoBlur: "Blurred elements will appear as un-blurred", exportNoforeignObject: "foreignObject elements will not appear", exportNoDashArray: "Strokes will appear filled", exportNoText: "Text may not appear as expected"}, Ob = ["clip-path", "fill", "filter", "marker-end", "marker-mid", "marker-start", "mask", "stroke"], Db = $.data, ub = document.createElementNS(c.SVG, "animate");
    $(ub).attr({attributeName: "opacity", begin: "indefinite", dur: 1, fill: "freeze"}).appendTo(q);
    var Bb = function(b) {
        var f,
                d = $(b).attr(Ob);
        for (f in d) {
    ...
    }, Na = {}, mb = i.imgPath + "logo.png", oa = [], Ma = {round_digits: 5}, ya = false, lb = null, ua = "select", db = "none", Fb = {}, Sa = v.text, Ta = t, Ua = null, Ca = null, rb = [], vb = {}, Oa = null, Eb = {};
    e.clipBoard = [];
    ...
    this.addExtension = function(b, f) {
        var d;
        if (b in vb)
            console.log('Cannot add extension "' + b + '", an extension by that name already exists"');
        else {
            d = $.isFunction(f) ? f($.extend(e.getPrivateMethods(), {svgroot: q, svgcontent: w, nonce: u().getNonce(), selectorManager: va})) : f;
            vb[b] = d;
    ...
    var Gb = this.round = function(b) {
        ...
        if (d == null || typeof d.item != "function") {
            ...
            for (j = rb.length; j--; )
                b.width && svgedit.math.rectsIntersect(b, rb[j].bbox) && d.push(rb[j].elem)
        }
        return d
    };
    getStrokedBBox = this.getStrokedBBox = function(b) {
        ...
        var f = function(G) {
            try {
                var K = svgedit.utilities.getBBox(G), C = svgedit.utilities.getRotationAngle(G);
                if (C && C % 90 || svgedit.math.hasMatrixTransform(svgedit.transformlist.getTransformList(G))) {
                    C = false;
                    if (["ellipse", "path", "line", "polyline", "polygon"].indexOf(G.tagName) >= 0)
                        K = C = e.convertToPath(G, true);
                    else if (G.tagName == "rect") {
                        var O = G.getAttribute("rx"), T = G.getAttribute("ry");
                        if (O || T)
                            K = C = e.convertToPath(G, true)
                    }
                    if (!C) {
                        var V = G.cloneNode(true), X = document.createElementNS(c.SVG, "g"), ca = G.parentNode;
                        ca.appendChild(X);
                        X.appendChild(V);
        ...
        if (d == null)
            return null;
        var r = d.x + d.width, j = d.y + d.height, E = d.x, n = d.y, z = function(G) {
            var K = G.getAttribute("stroke-width"), C = 0;
            if (G.getAttribute("stroke") != "none" && !isNaN(K))
                C += K / 2;
            return C
        }, B = [];
        $.each(b, function(G, K) {
    ...
    var sb = this.getVisibleElements = function(b) {
        ...
        $(b).children().each(function(d, r) {
            try {
                r.getBBox() && f.push({elem: r, bbox: getStrokedBBox([r])})
            } catch (j) {
            }
        });
        return f.reverse()
    ...
    this.setRotationAngle = function(b, f) {
        b = parseFloat(b);
        var d = m[0], r = d.getAttribute("transform"), j = svgedit.utilities.getBBox(d), E = j.x + j.width / 2, n = j.y + j.height / 2;
        ...
        if (b != 0) {
            ...
            j.numberOfItems == 0 && d.removeAttribute("transform");
        if (!f) {
    ...
    }, gc = [0, "z", "M", "m", "L", "l", "C", "c", "Q", "q", "A", "a", "H", "h", "V", "v", "S", "s", "T", "t"], Yb = function(b) {
        console.log([b.a, b.b, b.c, b.d, b.e, b.f])
    }, fb = null, za = this.clearSelection = function(b) {
        if (m[0] != null) {
            var f, d, r = m.length;
            for (f = 0; f < r; ++f) {
                d = m[f];
        ...
        if (b.length != 0) {
            ...
            for (var r = b.length; r--; ) {
                ...
                if (j && svgedit.utilities.getBBox(j)) {
                    if (j.tagName === "a" && j.childNodes.length === 1)
                        j = j.firstChild;
                    if (m.indexOf(j) == -1) {
                        m[d] = j;
                        d++;
            ...
            for (m.sort(function(E, n) {
                if (E && n && E.compareDocumentPosition)
                    return 3 - (n.compareDocumentPosition(E) & 6);
                if (E == null)
                    return 1
            }); m[0] == null; )
                m.shift(0)
    ...
    this.removeFromSelection = function(b) {
        if (m[0] != null)
            if (b.length != 0) {
                var f, d = 0, r = Array(m.length), j = m.length;
                for (f = 0; f < j; ++f) {
                    var E = m[f];
                    if (E)
                        if (b.indexOf(E) == -1) {
    ...
    var Ib = this.getMouseTarget = function(b) {
        if (b == null)
            return null;
        b = b.target;
        if (b.correspondingUseElement)
            b = b.correspondingUseElement;
        ...
        if ([q, a, w, f].indexOf(b) >= 0)
            return q;
        if ($(b).closest("#selectorParentGroup").length)
            return va.selectorParentGroup;
        for (; b.parentNode !== (p || f); )
            b = b.parentNode;
        return b
    };
    (function() {
        var b = null, f = null, d = null, r = null, j = null,
                E = {}, n = {minx: null, miny: null, maxx: null, maxy: null}, z = 0, B = {x: 0, y: 0}, G = {x: 0, y: 0}, K = {x: 0, y: 0}, C = {x: 0, y: 0}, O, T, V = {x: 0, y: 0}, X = {x: 0, y: 0}, ca = function(S) {
            var M = {x: 0, y: 0}, J = B, N = G, P = K, aa = C, ha = 1 / 6, pa = S * S, Aa = pa * S, ba = [[-1, 3, -3, 1], [3, -6, 3, 0], [-3, 0, 3, 0], [1, 4, 1, 0]];
        ...
        $(a).mousedown(function(S) {
            if (!(e.spaceKey || S.button === 1)) {
                ...
                var J = svgedit.math.transformPoint(S.pageX, S.pageY, fb), N = J.x * A, P = J.y * A;
                S.preventDefault();
                if (M) {
                    ua =
                            "select";
                ...
                P = P / A;
                var aa = Ib(S);
                if (aa.tagName === "a" && aa.childNodes.length === 1)
                    aa = aa.firstChild;
                r = f = N = J;
                var ha = P;
                j = d = P;
                ...
                switch (ua) {
                    case "select":
                        ...
                        if (aa != q) {
                            ...
                            r *= A;
                            j *= A;
                            svgedit.utilities.assignAttributes(Ca, {x: r, y: j, width: 0, height: 0, display: "inline"}, 100)
                        }
                        break;
                    case "zoom":
                        ya = true;
                        if (Ca == null)
                            Ca = va.getRubberBandBox();
                        svgedit.utilities.assignAttributes(Ca, {x: N * A, y: N * A, width: 0, height: 0, display: "inline"}, 100);
                        break;
                    case "resize":
                        ya = true;
                        f = J;
                    ...
                    case "fhpath":
                        ...
                        L({element: "polyline", curStyles: true, attr: {points: b, id: Ga(), fill: "none", opacity: t.opacity / 2, "stroke-linecap": "round", style: "pointer-events:none"}});
                        n.minx = N;
                        n.maxx = N;
                        n.miny = ha;
                        n.maxy = ha;
                    ...
                    case "image":
                        ya = true;
                        Aa = L({element: "image", attr: {x: J, y: P, width: 0, height: 0, id: Ga(), opacity: t.opacity / 2, style: "pointer-events:inherit"}});
                        Ba(Aa, mb);
                        wb(Aa);
                        break;
                    case "square":
                    case "rect":
                        ...
                        f = J;
                        d = P;
                        L({element: "rect", curStyles: true, attr: {x: J, y: P, width: 0, height: 0, id: Ga(), opacity: t.opacity / 2}});
                        break;
                    case "line":
                        ya = true;
                        Aa = t.stroke_width == 0 ? 1 : t.stroke_width;
                        L({element: "line", curStyles: true, attr: {x1: J, y1: P, x2: J, y2: P, id: Ga(), stroke: t.stroke, "stroke-width": Aa, "stroke-dasharray": t.stroke_dasharray, "stroke-linejoin": t.stroke_linejoin, "stroke-linecap": t.stroke_linecap, "stroke-opacity": t.stroke_opacity, fill: "none", opacity: t.opacity / 2, style: "pointer-events:none"}});
                        break;
                    case "circle":
                        ya =
                                true;
                        L({element: "circle", curStyles: true, attr: {cx: J, cy: P, r: 0, id: Ga(), opacity: t.opacity / 2}});
                        break;
                    case "ellipse":
                        ya = true;
                        L({element: "ellipse", curStyles: true, attr: {cx: J, cy: P, rx: 0, ry: 0, id: Ga(), opacity: t.opacity / 2}});
                        break;
                    case "text":
                        ya = true;
                        L({element: "text", curStyles: true, attr: {x: J, y: P, id: Ga(), fill: Sa.fill, "stroke-width": Sa.stroke_width, "font-size": Sa.font_size, "font-family": Sa.font_family, "text-anchor": "middle", "xml:space": "preserve", opacity: t.opacity}});
                        break;
                    case "path":
                    case "pathedit":
                        f *= A;
                ...
                S = nb("mouseDown", {event: S, start_x: f, start_y: d, selectedElements: m}, true);
            ...
            if (ya)
                if (!(S.button === 1 || e.spaceKey)) {
                    var M, J, N, P, aa, ha = m[0], pa = svgedit.math.transformPoint(S.pageX, S.pageY, fb), Aa = pa.x * A;
                    pa = pa.y * A;
                    ...
                    switch (ua) {
                        ...
                        case "multiselect":
                            J *= A;
                            P *= A;
                            svgedit.utilities.assignAttributes(Ca, {x: Math.min(r, J), y: Math.min(j, P), width: Math.abs(J - r), height: Math.abs(P - j)}, 100);
                            ba = [];
                            J = [];
                            wa = eb();
                            P = m.length;
                        ...
                        case "resize":
                            ...
                            if (db.indexOf("n") == -1 && db.indexOf("s") == -1)
                                N = 0;
                            if (db.indexOf("e") == -1 && db.indexOf("w") ==
                                    -1)
                                J = 0;
                            var Jb = hb = 0, Rb = $a ? ($a + N) / $a : 1, Kb = Da ? (Da + J) / Da : 1;
                            if (db.indexOf("n") >= 0) {
                                Rb = $a ? ($a - N) / $a : 1;
                                Jb = $a
                            }
                        ...
                        case "zoom":
                            J *= A;
                            P *= A;
                            svgedit.utilities.assignAttributes(Ca, {x: Math.min(r * A, J), y: Math.min(j * A, P), width: Math.abs(J - r * A), height: Math.abs(P - j * A)}, 100);
                            break;
                        case "text":
                            svgedit.utilities.assignAttributes(ba, {x: x, y: y}, 1E3);
                            break;
                        case "line":
                            P = null;
                        ...
                        case "image":
                            ...
                            svgedit.utilities.assignAttributes(ba, {width: J, height: M, x: P, y: wa}, 1E3);
                            break;
                        case "circle":
                            M = $(ba).attr(["cx", "cy"]);
                            J = M.cx;
                        ...
                        case "rotate":
                            ...
                            if (S.shiftKey)
                                aa = Math.round(aa / 45) * 45;
                            e.setRotationAngle(aa < -180 ? 360 + aa : aa, true);
                            ma("transition", m)
                    }
                    nb("mouseMove", {event: S, mouse_x: Aa, mouse_y: pa, selected: ha})
                }
        }).click(function(S) {
            S.preventDefault();
            return false
            ...
            if (S.button !== 2) {
                ...
                Ua = null;
                if (ya) {
                    var J = svgedit.math.transformPoint(S.pageX, S.pageY, fb), N = J.x * A;
                    J = J.y * A;
                    var P = N / A, aa = J / A, ha = svgedit.utilities.getElem(Ya()), pa = false;
                    ya = false;
                    switch (ua) {
                        case "resize":
                        case "multiselect":
                        ...
                        case "select":
                            if (m[0] != null) {
                                ...
                                if (P != r || aa != j) {
                                    ...
                                    N = S.target;
                                    if (m[0].nodeName === "path" && m[1] == null)
                                        ra.select(m[0]);
                                    else
                                        S.shiftKey && M != N && e.removeFromSelection([N])
                                }
                                if (svgedit.browser.supportsNonScalingStroke())
                                    if (S = m[0]) {
                        ...
                        case "zoom":
                            ...
                            ma("zoomed", {x: Math.min(r, P), y: Math.min(j, aa),
                                width: Math.abs(P - r), height: Math.abs(aa - j), factor: S.shiftKey ? 0.5 : 2});
                            return;
                        case "fhpath":
                            z = 0;
                            B = {x: 0, y: 0};
                            ...
                            P = M.indexOf(",");
                            if (pa = P >= 0 ? M.indexOf(",", P + 1) >= 0 : M.indexOf(" ", M.indexOf(" ") + 1) >= 0)
                                ha = ra.smoothPolylineIntoPath(ha);
                            break;
                        case "line":
                        ...
                        case "fhellipse":
                            if (n.maxx - n.minx > 0 && n.maxy - n.miny > 0) {
                                ha = L({element: "ellipse", curStyles: true, attr: {cx: (n.minx + n.maxx) / 2, cy: (n.miny + n.maxy) / 2, rx: (n.maxx - n.minx) / 2, ry: (n.maxy - n.miny) / 2, id: Ya()}});
                                ma("changed", [ha]);
                                pa = true
                            }
                            break;
                        case "fhrect":
                            if (n.maxx - n.minx > 0 && n.maxy - n.miny > 0) {
                                ha = L({element: "rect", curStyles: true, attr: {x: n.minx, y: n.miny, width: n.maxx - n.minx, height: n.maxy - n.miny,
                                        id: Ya()}});
                                ma("changed", [ha]);
                                pa = true
                            }
                    ...
                    N = nb("mouseUp", {event: S, mouse_x: N, mouse_y: J}, true);
                    ...
                    if (!pa && ha != null) {
                        ...
                        ha = null;
                        for (N = S.target; N.parentNode.parentNode.tagName == "g"; )
                            N = N.parentNode;
                        ...
                        if (ub.beginElement && ha.getAttribute("opacity") != t.opacity) {
                            Aa = $(ub).clone().attr({to: t.opacity, dur: S}).appendTo(ha);
                            try {
                                Aa[0].beginElement()
                            } catch (ba) {
                            }
        ...
        $(a).bind("mousewheel DOMMouseScroll", function(S) {
            ...
            M = {x: M.x, y: M.y, width: 0, height: 0};
    ...
    La = e.textActions = function() {
        function b(J) {
            ...
            svgedit.utilities.assignAttributes(K, {x1: N.x, y1: N.y, x2: P.x, y2: P.y, visibility: "visible", display: "inline"});
            C && C.setAttribute("d", "")
        }
        function f(J, N, P) {
            if (J === N)
                ...
                if (!C) {
                    ...
                    svgedit.utilities.assignAttributes(C, {id: "text_selectblock", fill: "green", opacity: 0.5, style: "pointer-events:none"});
                ...
                svgedit.utilities.assignAttributes(C, {d: "M" + N.x + "," + N.y + " L" + P.x + "," + P.y + " " + J.x + "," + J.y + " " + ha.x + "," + ha.y + "z", display: "inline"})
            }
        }
        function d(J, N) {
        ...
        function z(J) {
            if (M && B) {
                ...
                N = j(N.x * A, N.y * A);
                N = d(N.x, N.y);
                var P = B.textContent, aa = P.substr(0, N).replace(/[a-z0-9]+$/i, "").length;
        ...
        var B, G, K, C, O, T = [], V, X, ca, S, M;
        return{select: function(J, N, P) {
                B = J;
                La.toEditMode(N,
                        P)
            }, start: function(J) {
            ...
            }, setCursor: b, toEditMode: function(J, N) {
                M = false;
                ua = "textedit";
                ...
                if (B) {
                    ...
                    for (J = 0; J < P; J++) {
                        ...
                        T[J] = {x: aa.x, y: V.y, width: N.x - aa.x, height: V.height}
                    }
                    T.push({x: N.x, width: 0});
    ...
    ra = e.pathActions = function() {
        ...
        svgedit.path.Path.prototype.endChanges = function(n) {
            ...
            n = new svgedit.history.ChangeElementCommand(this.elem, {d: this.last_d}, n);
            Y(n);
        ...
        var j = f = null, E = false;
        return{mouseDown: function(n, z, B, G) {
                var K;
                if (ua === "path") {
                    mouse_x = B;
                    mouse_y = G;
                    ...
                    if (!B) {
                        ...
                        svgedit.utilities.assignAttributes(B, {id: "path_stretch_line", stroke: "#22C", "stroke-width": "0.5", fill: "none"});
                    ...
                    if (j) {
                        ...
                        if (T) {
                            ...
                            B = C;
                            if (b)
                                B += svgedit.path.path.segs.length;
                            svgedit.path.addPointGrip(B, G, z)
                        }
                    } else {
                        d_attr = "M" + G + "," + z + " ";
                        j = L({element: "path", curStyles: true, attr: {d: d_attr, id: Ga(), opacity: t.opacity / 2}});
                    ...
                    if (K.substr(0, 14) == "pathpointgrip_") {
                        ...
                        if (n.shiftKey)
                            C.selected ? svgedit.path.path.removePtFromSelection(z) : svgedit.path.path.addPtsToSelection(z);
                        else {
                            if (svgedit.path.path.selected_pts.length <= 1 || !C.selected)
                    ...
                    if (!svgedit.path.path.dragging) {
                        if (Ca == null)
                            Ca = va.getRubberBandBox();
                        svgedit.utilities.assignAttributes(Ca, {x: B * A, y: G * A, width: 0, height: 0, display: "inline"}, 100)
                    }
                }
                ...
                if (ua === "path") {
                    if (j) {
                        var B = j.pathSegList, G = B.numberOfItems - 1;
                        if (d) {
                            var K = svgedit.path.addCtrlGrip("1c1"), C = svgedit.path.addCtrlGrip("0c2");
                            K.setAttribute("cx", n);
                            K.setAttribute("cy", z);
                            ...
                            if (G.pathSegType === 6)
                                ...
                                r ? svgedit.path.replacePathSeg(6, 1, [n, z, r[0], r[1], n, z], K) : svgedit.path.replacePathSeg(4, 1, [n, z], K)
                        }
                    }
                } else if (svgedit.path.path.dragging) {
                    K = svgedit.path.getPointFromGrip({x: svgedit.path.path.dragging[0], y: svgedit.path.path.dragging[1]}, svgedit.path.path);
                    O = svgedit.path.getPointFromGrip({x: n, y: z}, svgedit.path.path);
                    G = O.x - K.x;
                    K = O.y - K.y;
                    ...
                    svgedit.path.path.eachSeg(function() {
                        if (this.next || this.prev) {
                            var ca = Ca.getBBox(), S = svgedit.path.getGripPt(this);
                            ca = svgedit.math.rectsIntersect(ca, {x: S.x, y: S.y, width: 0, height: 0});
                            this.select(ca);
                ...
                if (n)
                    if (svgedit.utilities.getRotationAngle(n) !=
                            0) {
                        var z = new svgedit.history.BatchCommand("Reorient path"), B = {d: n.getAttribute("d"), transform: n.getAttribute("transform")};
                ...
                if (j) {
                    ...
                    ua == "pathedit" && this.toSelectMode();
                svgedit.path.path && svgedit.path.path.init().show(false)
            }, resetOrientation: function(n) {
                if (n == null || n.nodeName != "path")
                    return false;
                var z = svgedit.transformlist.getTransformList(n), B = svgedit.math.transformListToTransform(z).matrix;
                z.clear();
                n.removeAttribute("transform");
                z = n.pathSegList;
                var G = z.numberOfItems, K;
                for (K = 0; K < G; ++K) {
                    var C = z.getItem(K), O = C.pathSegType;
                    if (O != 1) {
                        var T = [];
                        $.each(["", 1, 2], function(V, X) {
                            var ca = C["x" + X], S = C["y" + X];
                ...
                return{x: n.item.x, y: n.item.y, type: n.type}
                ...
                if (n.length === 1) {
                    var z = svgedit.path.path.elem, B = z.pathSegList, G = n[0], K = null, C = null;
                    ...
                    if (K == null)
                        K = svgedit.path.path.segs.length - 1;
                    if (K !== false) {
                        var O = z.createSVGPathSegLinetoAbs(C.x, C.y), T = z.createSVGPathSegClosePath();
                        ...
                        for (n = G - O - 1; n--; )
                            svgedit.path.insertItemBefore(z, B.getItem(O), T);
                        z = B.getItem(O);
                ...
                if (ra.canDeleteNodes) {
                    svgedit.path.path.storeD();
                    for (var n = svgedit.path.path.selected_pts, z = n.length; z--; )
                        svgedit.path.path.deleteSeg(n[z]);
                    var B = function() {
                        var G = svgedit.path.path.elem.pathSegList,
                                K = G.numberOfItems, C = function(V, X) {
                                    for (; X--; )
                                        G.removeItem(V)
                                };
                        if (K <= 1)
                ...
                var z = n.points, B = z.numberOfItems;
                if (B >= 4) {
                    var G = z.getItem(0), K = null, C = [];
                    C.push(["M", G.x, ",", G.y, " C"].join(""));
                    for (n = 1; n <= B - 4; n += 3) {
                        var O = z.getItem(n), T = z.getItem(n + 1), V = z.getItem(n + 2);
                        if (K)
                    ...
                    C = C.join(" ");
                    n = L({element: "path", curStyles: true, attr: {id: Ya(), d: C, fill: "none"}})
                }
                return n
                ...
                var z = n.pathSegList, B = z.numberOfItems, G, K;
                for (G = 0; G < B; ++G) {
                    var C = z.getItem(G);
                    if (C.pathSegType === 2)
                        K = C;
                ...
                var B, G = n.pathSegList, K = G.numberOfItems, C = 0,
                        O = 0, T = "", V = null;
                for (B = 0; B < K; ++B) {
                    var X = G.getItem(B), ca = X.x || 0, S = X.y || 0, M = X.x1 || 0, J = X.y1 || 0, N = X.x2 || 0, P = X.y2 || 0, aa = X.pathSegType, ha = gc[aa]["to" + (z ? "Lower" : "Upper") + "Case"](), pa = function(Aa, ba, wa) {
                        ba = ba ? " " + ba.join(" ") : "";
                    ...
                    switch (aa) {
                        ...
                        case 11:
                            ...
                            pa([[X.r1, X.r2]], [X.angle, X.largeArcFlag ? 1 : 0, X.sweepFlag ? 1 : 0], [ca, S]);
                            break;
                        case 16:
                            ca -= C;
                            N -= C;
    ...
    var Tb = this.removeUnusedDefElems = function() {
        ...
        if (!b || !b.length)
            return 0;
        var f = [], d = 0, r = ["fill", "stroke", "filter", "marker-start", "marker-mid", "marker-end"], j = r.length, E = w.getElementsByTagNameNS(c.SVG, "*"), n = E.length,
                z, B;
        for (z = 0; z < n; z++) {
            var G = E[z];
            for (B = 0; B < j; B++) {
    ...
    this.svgCanvasToString = function() {
        ...
        $(w).find("g:data(gsvg)").each(function() {
            var d = this.attributes, r = d.length, j;
            for (j = 0; j < r; j++)
                if (d[j].nodeName == "id" || d[j].nodeName == "style")
                    r--;
            if (r <= 0) {
                d = this.firstChild;
                b.push(d);
    ...
    this.svgToString = function(b, f) {
        var d = [], r = svgedit.utilities.toXml, j = i.baseUnit, E = RegExp("^-?[\\d\\.]+" + j + "$");
        if (b) {
            ta(b);
            var n = b.attributes, z, B, G = b.childNodes;
            for (B = 0; B < f; B++)
                d.push(" ");
            d.push("<");
            d.push(b.nodeName);
            if (b.id === "svgcontent") {
                ...
                if (b.nodeName === "defs" && !b.firstChild)
                    return;
                        ...
                        if (C != "")
                            if (C.indexOf("pointer-events") !== 0)
                                if (!(z.localName === "class" && C.indexOf("se_") === 0)) {
                                    d.push(" ");
                                    if (z.localName === "d")
                                        C = ra.convertPath(b, true);
                                    if (isNaN(C)) {
                                        if (E.test(C))
                                            C = svgedit.units.shortFloat(C) + j
                                    } else
                                        C = svgedit.units.shortFloat(C);
                                    if (Ma.apply && b.nodeName === "image" && z.localName === "href" && Ma.images && Ma.images === "embed") {
                                        var T = Na[C];
                                        if (T)
                                            C = T
                                    }
    ...
    this.rasterExport = function(b, f) {
        ...
        za();
        var r = [], j = {feGaussianBlur: qb.exportNoBlur, foreignObject: qb.exportNoforeignObject, "[stroke-dasharray]": qb.exportNoDashArray}, E = $(w);
        if (!("font"in $("<canvas>")[0].getContext("2d")))
            j.text = qb.exportNoText;
        $.each(j, function(n, z) {
            E.find(n).length && r.push(z)
        });
        j = this.svgCanvasToString();
        ma("exported", {svg: j, issues: r, type: b, mimeType: d, quality: f})
    };
    ...
    var Ub = this.uniquifyElems = function(b) {
        ...
        svgedit.utilities.walkTree(b, function(z) {
            if (z.nodeType == 1) {
                if (z.id) {
                    z.id in f || (f[z.id] = {elem: null, attrs: [], hrefs: []});
                    f[z.id].elem = z
                }
                $.each(Ob, function(G, K) {
                    ...
                    if (C) {
                        ...
                        if (O = O ? O.substr(1) : null) {
                            O in f || (f[O] = {elem: null, attrs: [], hrefs: []});
                            f[O].attrs.push(C)
                        }
                    }
                });
                ...
                if (B && d.indexOf(z.nodeName) >= 0)
                    if (B = B.substr(1)) {
                        B in f || (f[B] = {elem: null, attrs: [], hrefs: []});
                        f[B].hrefs.push(z)
                    }
            }
        });
        ...
        f.each(function() {
            ...
            if (d = svgedit.utilities.getElem(d)) {
                $(this).data("ref", d);
                if (d.tagName == "symbol" || d.tagName == "svg")
                    $(this).data("symbol", d).data("ref", d)
            }
        })
    }, Wb = this.convertGradients = function(b) {
        var f = $(b).find("linearGradient, radialGradient");
        if (!f.length && svgedit.browser.isWebkit())
            f = $(b).find("*").filter(function() {
                ...
                if (d.length)
                    if (d = svgedit.utilities.getBBox(d[0]))
                        if (this.tagName === "linearGradient") {
                            var r = $(this).attr(["x1", "y1", "x2", "y2"]), j = this.gradientTransform.baseVal;
                            ...
                            $(this).attr({x1: (r.x1 -
                                        d.x) / d.width, y1: (r.y1 - d.y) / d.height, x2: (r.x2 - d.x) / d.width, y2: (r.y2 - d.y) / d.height});
        ...
        b || (b = m[0]);
        var f = $(b), d = new svgedit.history.BatchCommand, r;
        if (f.data("gsvg")) {
            ...
            var n = b.childNodes, z;
            for (z = 0; z < n.length; z++)
                f.appendChild(n[z].cloneNode(true));
            if (svgedit.browser.isGecko()) {
                n =
            ...
            console.log("Unexpected element to ungroup:", b)
    };
    this.setSvgString = function(b) {
        try {
            ...
            var d = new svgedit.history.BatchCommand("Change Source"),
                    r = w.nextSibling, j = q.removeChild(w);
            ...
            var z = {id: "svgcontent", overflow: i.show_outside_canvas ? "visible" : "hidden"}, B = false;
            if (E.attr("viewBox")) {
                var G = E.attr("viewBox").split(" ");
                z.width = G[2];
                z.height = G[3]
            } else
                $.each(["width", "height"], function(T, V) {
                    var X = E.attr(V);
                    X || (X = "100%");
                    if (String(X).substr(-1) === "%")
                        B = true;
                    else
                        z[V] = svgedit.units.convertToNum(V, X)
                });
            yb();
    ...
    this.importSvgString =
            function(b) {
                var f, d;
                try {
                    var r = svgedit.utilities.encode64(b.length + b).substr(0, 32), j = false;
                    if (Fb[r])
                        if ($(Fb[r].symbol).parents("#svgroot").length)
                            j = true;
                    var E = new svgedit.history.BatchCommand("Import SVG"), n;
                    if (j) {
                        n = Fb[r].symbol;
                        d = Fb[r].xform
                    } else {
                        ...
                        Ub(B);
                        var G = svgedit.units.convertToNum("width", B.getAttribute("width")), K = svgedit.units.convertToNum("height", B.getAttribute("height")),
                                C = B.getAttribute("viewBox"), O = C ? C.split(" ") : [0, 0, G, K];
                        for (f = 0; f < 4; ++f)
                            O[f] = +O[f];
                        ...
                        for (svgedit.browser.isGecko() && $(B).find("linearGradient, radialGradient, pattern").appendTo(V); B.firstChild; )
                            n.appendChild(B.firstChild);
                        var X = B.attributes, ca;
    ...
    this.cloneLayer = function(b) {
        var f = new svgedit.history.BatchCommand("Duplicate Layer"), d = g.createElementNS(c.SVG, "g"), r = g.createElementNS(c.SVG, "title");
        r.textContent = b;
        d.appendChild(r);
        r = u().getCurrentLayer();
        $(r).after(d);
    ...
    this.deleteCurrentLayer = function() {
        var b = u().getCurrentLayer(), f = b.nextSibling, d = b.parentNode;
            ...
            if (!e.setCurrentLayer(b)) {
                ...
                for (f = 0; f < n; ++f) {
                    ...
                    if (z && z.tagName == "title") {
                        ...
                        z.textContent = b;
                        j.addSubCommand(new svgedit.history.ChangeElementCommand(z, {"#text": E}));
                        Y(j);
                        ma("changed", [r]);
                        return true
                    }
    ...
    this.setCurrentLayerPosition = function(b) {
        ...
        if (d.current_layer && b >= 0 && b < d.getNumLayers()) {
            for (f = 0; f < d.getNumLayers(); ++f)
                if (d.all_layers[f][1] == d.current_layer)
                    break;
            if (f == d.getNumLayers())
                return false;
            if (f != b) {
                var r = null, j = d.current_layer.nextSibling;
                if (b > f) {
                    if (b < d.getNumLayers() - 1)
                        r = d.all_layers[b + 1][1]
                } else
                    r = d.all_layers[b][1];
    ...
    this.setLayerVisibility = function(b, f) {
        var d = u(), r = d.getLayerVisibility(b), j = d.setLayerVisibility(b, f);
        if (j)
            Y(new svgedit.history.ChangeElementCommand(j, {display: r ? "inline" : "none"}, "Layer Visibility"));
        else
            return false;
        if (j == d.getCurrentLayer()) {
            za();
            ra.clear()
        }
        return true
    ...
    this.moveSelectedToLayer = function(b) {
        ...
        for (f = r.length; f--; ) {
            var j = r[f];
            if (j) {
                var E = j.nextSibling, n = j.parentNode;
                d.appendChild(j);
    ...
    this.mergeLayer = function(b) {
        var f = new svgedit.history.BatchCommand("Merge Layer"), d = u(), r = $(d.current_layer).prev()[0];
        if (r) {
    ...
    this.mergeAllLayers = function() {
        var b = new svgedit.history.BatchCommand("Merge all Layers"),
                f = u();
        for (f.current_layer = f.all_layers[f.getNumLayers() - 1][1]; $(w).children("g").length > 1; )
            b.addSubCommand(e.mergeLayer(true));
        za();
        yb();
        ma("changed", [w]);
        Y(b)
    ...
    var xb = this.getResolution = function() {
        var b = w.getAttribute("width") / A, f = w.getAttribute("height") / A;
        return{w: b, h: f, zoom: A}
    };
    ...
    this.setGroupTitle = function(b) {
        var f = m[0];
        f = $(f).data("gsvg") || f;
        var d = $(f).children("title"), r = new svgedit.history.BatchCommand("Set Label");
        if (b.length)
            if (d.length) {
                d = d[0];
                r.addSubCommand(new svgedit.history.ChangeElementCommand(d, {"#text": d.textContent}));
                d.textContent = b
            } else {
    ...
    this.setDocumentTitle = function(b) {
        var f, d = w.childNodes, r = false, j = "", E = new svgedit.history.BatchCommand("Change Image Title");
        ...
        if (b.length)
            ...
            r.parentNode.removeChild(r);
        E.addSubCommand(new svgedit.history.ChangeElementCommand(r, {"#text": j}));
        Y(E)
    };
    ...
    this.setResolution = function(b, f) {
        ...
        if (b != r || f != d) {
            ...
            this.contentW = b;
            this.contentH = f;
            j.addSubCommand(new svgedit.history.ChangeElementCommand(w, {width: r, height: d}));
            w.setAttribute("viewBox", [0, 0, b / A, f / A].join(" "));
            j.addSubCommand(new svgedit.history.ChangeElementCommand(w, {viewBox: ["0 0", r, d].join(" ")}));
            Y(j);
            q.unsuspendRedraw(n);
            ma("changed", [w])
        }
    ...
    this.setBBoxZoom = function(b, f, d) {
        ...
        switch (b) {
            ...
            case "canvas":
                b = xb();
                r = 0.95;
                b = {width: b.w, height: b.h, x: 0, y: 0};
                break;
            case "content":
                b =
                        getStrokedBBox();
    ...
    this.setColor = function(b, f, d) {
        ...
        t[b] = f;
        Ta[b + "_paint"] = {type: "solidColor"};
        for (var j = [], E = m.length; E--; ) {
            var n = m[E];
            if (n)
                if (n.tagName == "g")
                    svgedit.utilities.walkTree(n, r);
                else if (b == "fill")
                    n.tagName != "polyline" && n.tagName != "line" && j.push(n);
                else
                    j.push(n)
        }
        if (j.length > 0)
    ...
    var ac = this.setGradient = function(b) {
        if (!(!Ta[b + "_paint"] || Ta[b + "_paint"].type == "solidColor")) {
            var f = e[b + "Grad"], d = $b(f), r = svgedit.utilities.findDefs();
            if (d)
                f = d;
            else {
        ...
        for (var d = f.length, r = ["r", "cx", "cy", "fx", "fy"]; d--; ) {
            ...
            if (b.tagName == "linearGradient") {
                if (b.getAttribute("x1") != j.getAttribute("x1") || b.getAttribute("y1") != j.getAttribute("y1") || b.getAttribute("x2") != j.getAttribute("x2") || b.getAttribute("y2") != j.getAttribute("y2"))
                    continue
            } else {
                var E = $(b).attr(r), n = $(j).attr(r), z = false;
                $.each(r, function(T, V) {
                    if (E[V] !=
                            n[V])
                        z = true
            ...
            var B = b.getElementsByTagNameNS(c.SVG, "stop"), G = j.getElementsByTagNameNS(c.SVG, "stop");
            if (B.length == G.length) {
                for (var K = B.length; K--; ) {
                    var C = B[K], O = G[K];
                    if (C.getAttribute("offset") != O.getAttribute("offset") || C.getAttribute("stop-opacity") != O.getAttribute("stop-opacity") || C.getAttribute("stop-color") != O.getAttribute("stop-color"))
                        break
                }
                if (K == -1)
                    return j
    ...
    this.setStrokeWidth = function(b) {
        ...
        if (b == 0 && ["line", "path"].indexOf(ua) >= 0)
            ...
            for (var d = [], r = m.length; r--; ) {
                var j = m[r];
                if (j)
                    j.tagName == "g" ? svgedit.utilities.walkTree(j, f) : d.push(j)
            }
            if (d.length > 0) {
                Va("stroke-width", b, d);
                ma("changed", m)
    ...
    this.setStrokeAttr = function(b, f) {
        ...
        for (var d = [], r = m.length; r--; ) {
            var j = m[r];
            if (j)
                j.tagName == "g" ? svgedit.utilities.walkTree(j, function(E) {
                    E.nodeName != "g" && d.push(E)
                }) : d.push(j)
        }
        if (d.length > 0) {
    ...
    this.getBlur = function(b) {
        ...
        if (b)
            if (b.getAttribute("filter"))
                if (b = svgedit.utilities.getElem(b.id + "_blur"))
                    f = b.firstChild.getAttribute("stdDeviation");
        return f
    };
    (function() {
        function b() {
        ...
        e.setBlurOffsets = function(j, E) {
            if (E > 3)
                svgedit.utilities.assignAttributes(j, {x: "-50%", y: "-50%",
        ...
        e.setBlur = function(j, E) {
            if (f)
                ...
                if (d) {
                    ...
                    var G = L({element: "feGaussianBlur", attr: {"in": "SourceGraphic", stdDeviation: j}});
                    d = L({element: "filter", attr: {id: z + "_blur"}});
                    d.appendChild(G);
                    svgedit.utilities.findDefs().appendChild(d);
                    B.addSubCommand(new svgedit.history.InsertElementCommand(d))
                }
                G = {filter: n.getAttribute("filter")};
                if (j === 0) {
    ...
    this.getBold = function() {
        ...
        if (b != null && b.tagName == "text" && m[1] ==
                null)
            return b.getAttribute("font-weight") == "bold";
        return false
    };
    this.setBold = function(b) {
        var f = m[0];
        if (f != null && f.tagName == "text" && m[1] == null)
            Va("font-weight", b ? "bold" : "normal");
        m[0].textContent || La.setCursor()
    };
    this.getItalic = function() {
        var b = m[0];
        if (b != null && b.tagName == "text" && m[1] == null)
            return b.getAttribute("font-style") == "italic";
        return false
    };
    this.setItalic = function(b) {
        var f = m[0];
        if (f != null && f.tagName == "text" && m[1] == null)
            Va("font-style", b ? "italic" : "normal");
        m[0].textContent || La.setCursor()
    };
    ...
    this.setImageURL = function(b) {
        ...
        if (f) {
            ...
            Ba(f, b);
            j.addSubCommand(new svgedit.history.ChangeElementCommand(f, {"#href": r}));
            d ? $(new Image).load(function() {
                var E = $(f).attr(["width", "height"]);
                $(f).attr({width: this.width, height: this.height});
    ...
    this.setLinkURL = function(b) {
        ...
        if (f) {
            ...
            if (d !== b) {
                ...
                Ba(f, b);
                r.addSubCommand(new svgedit.history.ChangeElementCommand(f, {"#href": d}));
                Y(r)
            }
        }
    };
    ...
    this.convertToPath = function(b, f) {
        if (b == null)
            ...
            if (!f)
                var d = new svgedit.history.BatchCommand("Convert element to Path");
            var r = f ? {} : {fill: t.fill, "fill-opacity": t.fill_opacity, stroke: t.stroke, "stroke-width": t.stroke_width, "stroke-dasharray": t.stroke_dasharray,
                "stroke-linejoin": t.stroke_linejoin, "stroke-linecap": t.stroke_linecap, "stroke-opacity": t.stroke_opacity, opacity: t.opacity, visibility: "hidden"};
            $.each(["marker-start", "marker-end", "marker-mid", "filter", "clip-path"], function() {
                if (b.getAttribute(this))
                    r[this] = b.getAttribute(this)
            });
            var j = L({element: "path", attr: r}), E = b.getAttribute("transform");
            E && j.setAttribute("transform", E);
            var n = b.id, z = b.parentNode;
            ...
            switch (b.tagName) {
                ...
                case "circle":
                    ...
                    if (b.tagName == "circle")
                        O = ry = $(b).attr("r");
                    G([["M", [T - O, V]], ["C", [T - O, V - ry / K, T - O / K, V - ry, T, V - ry]], ["C", [T + O / K, V - ry, T + O, V - ry / K, T + O, V]], ["C", [T + O, V + ry / K, T + O / K, V + ry, T, V + ry]], ["C", [T - O / K, V + ry, T - O, V + ry / K, T - O, V]], ["Z", []]]);
                    break;
                case "path":
                    B = b.getAttribute("d");
                    break;
                ...
                case "rect":
                    ...
                    X = X.height;
                    K = 4 - K;
                    !O && !ry ? G([["M", [C, T]], ["L", [C + V, T]], ["L", [C + V, T + X]], ["L", [C, T + X]], ["L", [C, T]], ["Z", []]]) : G([["M", [C, T + ry]], ["C", [C, T + ry / K, C + O / K, T, C + O, T]], ["L", [C + V - O, T]], ["C", [C + V - O / K, T, C + V, T + ry / K, C + V, T + ry]], ["L", [C + V, T + X - ry]], ["C", [C + V, T + X - ry / K, C + V - O / K, T + X, C + V - O, T + X]], ["L", [C + O, T + X]], ["C", [C + O /
                                        K, T + X, C, T + X - ry / K, C, T + X - ry]], ["L", [C, T + ry]], ["Z", []]]);
                    break;
                default:
                ...
                if ((b === "x" || b === "y") && E.indexOf(z.tagName) >= 0) {
                    ...
                    if (B !== String(f)) {
                        if (b == "#text") {
                            ...
                            z.textContent = f;
                            if (/rotate/.test(z.getAttribute("transform")))
                                z = Hb(z)
                        } else
                            b == "#href" ? Ba(z, f) : z.setAttribute(b, f);
                        ...
                        if (svgedit.browser.isGecko() && z.nodeName === "text" && /rotate/.test(z.getAttribute("transform")))
                            if (String(f).indexOf("url") === 0 || ["font-size", "font-family", "x", "y"].indexOf(b) >= 0 && z.textContent)
                                z = Hb(z);
                        ...
                        if (B != 0 && b != "transform")
                            for (var G = svgedit.transformlist.getTransformList(z), K = G.numberOfItems; K--; )
                                if (G.getItem(K).type == 4) {
                                    G.removeItem(K);
                                    var C = svgedit.utilities.getBBox(z), O = svgedit.math.transformPoint(C.x + C.width / 2, C.y + C.height / 2, svgedit.math.transformListToTransform(G).matrix);
                                    C = O.x;
                                    O = O.y;
    ...
    this.deleteSelectedElements = function() {
        var b, f = new svgedit.history.BatchCommand("Delete Elements"), d = m.length, r = [];
        for (b = 0; b < d; ++b) {
            var j = m[b];
            if (j == null)
                break;
            var E = j.parentNode, n = j;
    ...
    this.cutSelectedElements = function() {
        var b, f = new svgedit.history.BatchCommand("Cut Elements"), d = m.length, r = [];
        for (b = 0; b < d; ++b) {
            var j = m[b];
            if (j == null)
                break;
    ...
    this.pasteElements =
            function(b, f, d) {
                var r = e.clipBoard, j = r.length;
                if (j) {
                    for (var E = [], n = new svgedit.history.BatchCommand("Paste elements"); j--; ) {
                        var z = r[j];
                        if (z) {
                            var B = ob(z);
                            if (!svgedit.utilities.getElem(z.id))
                                B.id = z.id;
                            E.push(B);
                    ...
                    if (b !== "in_place") {
                        ...
                        b = getStrokedBBox(E);
                        var C = G - (b.x + b.width / 2), O = K - (b.y + b.height / 2), T = [], V = [];
                        $.each(E, function() {
                            T.push(C);
                            V.push(O)
                        });
        ...
        for (r = m.length; r--; ) {
            ...
            if (E != null) {
                if (E.parentNode.tagName === "a" && E.parentNode.childNodes.length ===
                        1)
                    E = E.parentNode;
                var n = E.nextSibling, z = E.parentNode;
                j.appendChild(E);
    ...
    var tb = this.pushGroupProperties = function(b, f) {
        var d = b.childNodes, r = d.length, j = b.getAttribute("transform"), E = svgedit.transformlist.getTransformList(b), n = svgedit.math.transformListToTransform(E).matrix, z = new svgedit.history.BatchCommand("Push group properties"), B = 0, G = svgedit.utilities.getRotationAngle(b), K = $(b).attr(["filter", "opacity"]),
                C, O, T;
        for (B = 0; B < r; B++) {
            var V = d[B];
            if (V.nodeType === 1) {
                ...
                if (K.filter) {
                    ...
                    if (X)
                        ...
                        X = O;
                    if (T)
                        C = svgedit.utilities.getRefElem(V.getAttribute("filter"));
                    else if (C) {
                        C = ob(C);
                        svgedit.utilities.findDefs().appendChild(C)
                    } else
                        C = svgedit.utilities.getRefElem(K.filter);
                ...
                if (~V.tagName.indexOf("Gradient"))
                    X = null;
                if (X)
                    if (V.tagName !== "defs")
                        if (E.numberOfItems) {
                            if (G && E.numberOfItems == 1) {
                                var ca = E.getItem(0).matrix, S = q.createSVGMatrix();
                                if (T = svgedit.utilities.getRotationAngle(V))
                                    S = X.getItem(0).matrix;
                                var M = svgedit.utilities.getBBox(V), J = svgedit.math.transformListToTransform(X).matrix, N = svgedit.math.transformPoint(M.x +
                                ...
                                T && X.removeItem(0);
                                if (M)
                                    X.numberOfItems ? X.insertItemBefore(J, 0) : X.appendItem(J);
                                if (ca.e || ca.f) {
        ...
        if ($(b).data("gsvg") || $(b).data("symbol"))
            ...
            if (b.tagName === "g" || b.tagName === "a") {
                ...
                for (var r = b.nextSibling, j = Array(b.childNodes.length), E = 0; b.firstChild; ) {
                    var n = b.firstChild, z = n.nextSibling, B = n.parentNode;
                    if (n.tagName === "title") {
    ...
    this.moveToTopSelectedElement = function() {
        ...
        if (b != null) {
            b = b;
            var f = b.parentNode, d = b.nextSibling;
    ...
    this.moveToBottomSelectedElement = function() {
        ...
        if (b != null) {
            b = b;
            var f = b.parentNode, d = b.nextSibling, r = b.parentNode.firstChild;
            if (r.tagName == "title")
                r = r.nextSibling;
            if (r.tagName == "defs")
                r = r.nextSibling;
    ...
    this.moveSelectedElements = function(b, f, d) {
        ...
        for (var r = new svgedit.history.BatchCommand("position"), j = m.length; j--; ) {
            var E = m[j];
            if (E != null) {
                var n = q.createSVGTransform(), z = svgedit.transformlist.getTransformList(E);
    ...
    this.cloneSelectedElements = function(b, f) {
        var d, r, j = new svgedit.history.BatchCommand("Clone Elements"), E = m.length;
        m.sort(function(n, z) {
    ...
    this.alignSelectedElements =
            function(b, f) {
                var d, r, j = [], E = Number.MAX_VALUE, n = Number.MIN_VALUE, z = Number.MAX_VALUE, B = Number.MIN_VALUE, G = Number.MIN_VALUE, K = Number.MIN_VALUE, C = m.length;
                if (C) {
                    for (d = 0; d < C; ++d) {
                        if (m[d] == null)
                            break;
                        ...
                        switch (f) {
                            ...
                            default:
                                ...
                                if (j[d].y < z)
                                    z = j[d].y;
                                if (j[d].x + j[d].width > n)
                                    n = j[d].x + j[d].width;
                                if (j[d].y + j[d].height > B)
                                    B = j[d].y + j[d].height
                            }
                    }
                    if (f == "page") {
    ...
    this.updateCanvas = function(b, f) {
        ...
        var d = $("#canvasBackground")[0], r = w.getAttribute("x"), j = w.getAttribute("y"), E = b / 2 - this.contentW * A / 2, n = f / 2 - this.contentH * A / 2;
        svgedit.utilities.assignAttributes(w,
                {width: this.contentW * A, height: this.contentH * A, x: E, y: n, viewBox: "0 0 " + this.contentW + " " + this.contentH});
        svgedit.utilities.assignAttributes(d, {width: w.getAttribute("width"), height: w.getAttribute("height"), x: E, y: n});
        (d = svgedit.utilities.getElem("background_image")) && svgedit.utilities.assignAttributes(d, {width: "100%", height: "100%"});
        va.selectorParentGroup.setAttribute("transform", "translate(" + E + "," + n + ")");
        nb("canvasUpdated", {new_x: E, new_y: n, old_x: r, old_y: j, d_x: E - r, d_y: n - j});
        return{x: E, y: n, old_x: r, old_y: j,
            d_x: E - r, d_y: n - j}
    };
    this.setBackground = function(b, f) {
        var d = svgedit.utilities.getElem("canvasBackground"), r = $(d).find("rect")[0], j = svgedit.utilities.getElem("background_image");
        r.setAttribute("fill", b);
        if (f) {
            if (!j) {
                j = g.createElementNS(c.SVG, "image");
                svgedit.utilities.assignAttributes(j, {id: "background_image", width: "100%", height: "100%", preserveAspectRatio: "xMinYMin", style: "pointer-events:none"})
            }
            Ba(j, f);
            d.appendChild(j)
        } else
    ...
    this.getPrivateMethods = function() {
        return{addCommandToHistory: Y, setGradient: ac, addSvgElementFromJson: L, assignAttributes: ib, BatchCommand: Xb, call: ma, ChangeElementCommand: jb, copyElem: ob, ffClone: Hb, findDefs: ea, findDuplicateGradient: $b, getElem: kb, getId: Ya, getIntersectionList: eb,
            getMouseTarget: Ib, getNextId: Ga, getPathBBox: Lb, getUrlFromAttr: ka, hasMatrixTransform: qa, identifyLayers: yb, InsertElementCommand: bb, isIdentity: svgedit.math.isIdentity, logMatrix: Yb, matrixMultiply: da, MoveElementCommand: Ab, preventClickDefault: wb, recalculateAllSelectedDimensions: Qb, recalculateDimensions: Mb, remapElement: pb, RemoveElementCommand: Wa, removeUnusedDefElems: Tb, round: Gb, runExtensions: nb, sanitizeSvg: Nb, SVGEditTransformList: svgedit.transformlist.SVGTransformList, toString: toString, transformBox: svgedit.math.transformBox,
            transformListToTransform: fa, transformPoint: R, walkTree: svgedit.utilities.walkTree}
    }
};
(function() {
    if (!window.svgEditor) {
        window.svgEditor = function(a) {
            ...
            var c, i, s = svgedit.utilities, e = false, g = [], q = {}, w = {lang: "", iconsize: "", bkgd_color: "#FFF", bkgd_url: "", img_save: "embed", save_notice_done: false, export_notice_done: false}, D = {}, u = {extensions: [], allowedOrigins: []}, A = ["ext-overview_window.js",
                "ext-markers.js", "ext-connector.js", "ext-eyedropper.js", "ext-shapes.js", "ext-imagelib.js", "ext-grid.js", "ext-polygon.js", "ext-star.js", "ext-panning.js", "ext-storage.js"], p = {canvasName: "default", canvas_expansion: 3, initFill: {color: "FF0000", opacity: 1}, initStroke: {width: 5, color: "000000", opacity: 1}, initOpacity: 1, colorPickerCSS: null, initTool: "select", wireframe: false, showlayers: false, no_save_warning: false, imgPath: "images/", langPath: "locale/", extPath: "extensions/", jGraduatePath: "jgraduate/images/", dimensions: [640,
                    480], gridSnapping: false, gridColor: "#000", baseUnit: "px", snappingStep: 10, showRulers: true, preventAllURLConfig: false, preventURLContentLoading: false, lockExtensions: false, noDefaultExtensions: false, showGrid: false, noStorageOnLoad: false, forceStorage: false, emptyStorageOnDecline: false}, v = o.uiStrings = {common: {ok: "OK", cancel: "Cancel", key_up: "Up", key_down: "Down", key_backspace: "Backspace", key_del: "Del"}, layers: {layer: "Layer"}, notification: {invalidAttrValGiven: "Invalid value given", noContentToFitTo: "No content to fit to",
                    dupeLayerName: "There is already a layer named that!", enterUniqueLayerName: "Please enter a unique layer name", enterNewLayerName: "Please enter the new layer name", layerHasThatName: "Layer already has that name", QmoveElemsToLayer: "Move selected elements to layer '%s'?", QwantToClear: "Do you want to clear the drawing?\nThis will also erase your undo history!", QwantToOpen: "Do you want to open a new file?\nThis will also erase your undo history!", QerrorsRevertToSource: "There were parsing errors in your SVG source.\nRevert back to original SVG source?",
                    ...
                    enterNewLinkURL: "Enter the new hyperlink URL", errorLoadingSVG: "Error: Unable to load SVG data", URLloadFail: "Unable to load from URL", retrieving: "Retrieving '%s' ..."}};
            a.pref = function(t, m) {
                if (m) {
                    D[t] = m;
                    o.curPrefs = D
                } else
                    return t in D ? D[t] : w[t]
            };
                ...
                if (!(!u.forceStorage && (u.noStorageOnLoad || !document.cookie.match(/(?:^|;\s*)store=(?:prefsAndContent|prefsOnly)/)))) {
                    ...
                    for (var m in w)
                        if (w.hasOwnProperty(m)) {
                            t = "svg-edit-" + m;
                            if (o.storage) {
                                if (t = o.storage.getItem(t))
                                    w[m] = String(t)
                            } else if (window.widget)
                                w[m] = widget.preferenceForKey(t);
                            else {
            ...
            o.setConfig = function(t, m) {
                function L(R, da, qa) {
                    if (R[da] && typeof R[da] === "object")
                        a.extend(true, R[da], qa);
                    else
                        R[da] = qa
                }
                m = m || {};
                            ...
                            if (t.hasOwnProperty(R))
                                if (w.hasOwnProperty(R)) {
                                    if (!(m.overwrite === false && (u.preventAllURLConfig || D.hasOwnProperty(R))))
                                        if (m.allowInitialUserOverride === true)
                                            w[R] = da;
                                        else
                                            a.pref(R, da)
                                } else if (["extensions", "allowedOrigins"].indexOf(R) > -1)
                                    m.overwrite === false && (u.preventAllURLConfig || R === "allowedOrigins" || R === "extensions" && u.lockExtensions) || (u[R] = u[R].concat(da));
                                else if (p.hasOwnProperty(R))
                                    if (!(m.overwrite === false && (u.preventAllURLConfig || u.hasOwnProperty(R))))
                                        if (u.hasOwnProperty(R))
                                            m.overwrite !==
                                                    false && L(u, R, da);
                                        else if (m.allowInitialUserOverride === true)
                                            L(p, R, da);
            ...
            o.setCustomHandlers = function(t) {
                o.ready(function() {
                    ...
                    if (t.exportImage || t.pngsave)
                        c.bind("exported", t.exportImage || t.pngsave);
                    q = t
                })
            };
            ...
            o.init = function() {
                function t() {
                    u = a.extend(true, {}, p, u);
                    if (!u.noDefaultExtensions)
                        u.extensions = u.extensions.concat(A);
                ...
                function da(h, k) {
                    k || (k = c.getZoom());
                    h || (h = a("#svgcanvas"));
                    var H, F, Q = c.getContentElem(), U = svgedit.units.getTypeMap()[u.baseUnit];
                    for (H = 0; H < 2; H++) {
                        var Z = H === 0, ga = Z ? "x" : "y", ja = Z ? "width" : "height", la = Number(Q.getAttribute(ga));
                        ...
                        var Ha = 0, W = na.getContext("2d"), Ea, xa,
                                Ja;
                ...
                function fa() {
                    ...
                    a.prompt(v.notification.enterUniqueLayerName, h, function(k) {
                        if (k)
                            if (c.getCurrentDrawing().hasLayer(k))
                                a.alert(v.notification.dupeLayerName);
                            else {
                                c.cloneLayer(k);
                                cb();
                                Ua()
                ...
                function ea(h) {
                    var k = a("#layerlist tr.layersel").index(), H =
                    ...
                    if (a.isEmptyObject(i)) {
                        ...
                        if (i.dimensions)
                            i.dimensions =
                                    i.dimensions.split(",");
                        if (i.bkgd_color)
                            i.bkgd_color = "#" + i.bkgd_color;
                        if (i.extensions)
                            i.extensions = i.extensions.match(/[:\/\\]/) ? "" : i.extensions.split(",");
                        a.each(["extPath", "imgPath", "langPath", "jGraduatePath"], function(H) {
                            i[H] && delete i[H]
                        });
                        o.setConfig(i, {overwrite: false});
                        t();
                        if (!u.preventURLContentLoading) {
                            h = i.source;
                            k = a.param.querystring();
                            if (!h)
                                if (k.indexOf("source=data:") >= 0)
                                    h = k.match(/source=(data:[^&]*)/)[1];
                            if (h) {
                                if (h.indexOf("data:") === 0) {
                                    h = h.replace(/ /g, "+");
                                    o.loadFromDataURI(h)
                        ...
                        if (!i.noStorageOnLoad || u.forceStorage)
                            o.loadContentAndPrefs()
                    }
                    D = a.extend(true, {}, w, D);
                    o.curPrefs = D
                ...
                a.svgIcons(u.imgPath + "svg_edit_icons.svg", {w: 24, h: 24, id_match: false, no_img: !svgedit.browser.isWebkit(), fallback_path: u.imgPath, fallback: {new_image: "clear.png",
                        save: "save.png", open: "open.png", source: "source.png", docprops: "document-properties.png", wireframe: "wireframe.png", undo: "undo.png", redo: "redo.png", select: "select.png", select_node: "select_node.png", pencil: "fhpath.png", pen: "line.png", square: "square.png", rect: "rect.png", fh_rect: "freehand-square.png", circle: "circle.png", ellipse: "ellipse.png", fh_ellipse: "freehand-circle.png", path: "path.png", text: "text.png", image: "image.png", zoom: "zoom.png", clone: "clone.png", node_clone: "node_clone.png", "delete": "delete.png",
                        node_delete: "node_delete.png", group: "shape_group_elements.png", ungroup: "shape_ungroup.png", move_top: "move_top.png", move_bottom: "move_bottom.png", to_path: "to_path.png", link_controls: "link_controls.png", reorient: "reorient.png", align_left: "align-left.png", align_center: "align-center.png", align_right: "align-right.png", align_top: "align-top.png", align_middle: "align-middle.png", align_bottom: "align-bottom.png", go_up: "go-up.png", go_down: "go-down.png", ok: "save.png", cancel: "cancel.png", arrow_right: "flyouth.png",
                        arrow_down: "dropdown.gif"}, placement: {"#logo": "logo", "#tool_clear div,#layer_new": "new_image", "#tool_save div": "save", "#tool_export div": "export", "#tool_open div div": "open", "#tool_import div div": "import", "#tool_source": "source", "#tool_docprops > div": "docprops", "#tool_wireframe": "wireframe", "#tool_undo": "undo", "#tool_redo": "redo", "#tool_select": "select", "#tool_fhpath": "pencil", "#tool_line": "pen", "#tool_rect,#tools_rect_show": "rect", "#tool_square": "square", "#tool_fhrect": "fh_rect", "#tool_ellipse,#tools_ellipse_show": "ellipse",
                        "#tool_circle": "circle", "#tool_fhellipse": "fh_ellipse", "#tool_path": "path", "#tool_text,#layer_rename": "text", "#tool_image": "image", "#tool_zoom": "zoom", "#tool_clone,#tool_clone_multi": "clone", "#tool_node_clone": "node_clone", "#layer_delete,#tool_delete,#tool_delete_multi": "delete", "#tool_node_delete": "node_delete", "#tool_add_subpath": "add_subpath", "#tool_openclose_path": "open_path", "#tool_move_top": "move_top", "#tool_move_bottom": "move_bottom", "#tool_topath": "to_path", "#tool_node_link": "link_controls",
                        "#tool_reorient": "reorient", "#tool_group_elements": "group_elements", "#tool_ungroup": "ungroup", "#tool_unlink_use": "unlink_use", "#tool_alignleft, #tool_posleft": "align_left", "#tool_aligncenter, #tool_poscenter": "align_center", "#tool_alignright, #tool_posright": "align_right", "#tool_aligntop, #tool_postop": "align_top", "#tool_alignmiddle, #tool_posmiddle": "align_middle", "#tool_alignbottom, #tool_posbottom": "align_bottom", "#cur_position": "align", "#linecap_butt,#cur_linecap": "linecap_butt", "#linecap_round": "linecap_round",
                        "#linecap_square": "linecap_square", "#linejoin_miter,#cur_linejoin": "linejoin_miter", "#linejoin_round": "linejoin_round", "#linejoin_bevel": "linejoin_bevel", "#url_notice": "warning", "#layer_up": "go_up", "#layer_down": "go_down", "#layer_moreopts": "context_menu", "#layerlist td.layervis": "eye", "#tool_source_save,#tool_docprops_save,#tool_prefs_save": "ok", "#tool_source_cancel,#tool_docprops_cancel,#tool_prefs_cancel": "cancel", "#rwidthLabel, #iwidthLabel": "width", "#rheightLabel, #iheightLabel": "height", "#cornerRadiusLabel span": "c_radius",
                        "#angleLabel": "angle", "#linkLabel,#tool_make_link,#tool_make_link_multi": "globe_link", "#zoomLabel": "zoom", "#tool_fill label": "fill", "#tool_stroke .icon_label": "stroke", "#group_opacityLabel": "opacity", "#blurLabel": "blur", "#font_sizeLabel": "fontsize", ".flyout_arrow_horiz": "arrow_right", ".dropdown button, #main_button .dropdown": "arrow_down", "#palette .palette_item:first, #fill_bg, #stroke_bg": "no_color"}, resize: {"#logo .svg_icon": 28, ".flyout_arrow_horiz .svg_icon": 5, ".layer_button .svg_icon, #layerlist td.layervis .svg_icon": 14,
                        ".dropdown button .svg_icon": 7, "#main_button .dropdown .svg_icon": 9, ".palette_item:first .svg_icon": 15, "#fill_bg .svg_icon, #stroke_bg .svg_icon": 16, ".toolbar_button button .svg_icon": 16, ".stroke_tool div div .svg_icon": 20, "#tools_bottom label .svg_icon": 18}, callback: function() {
                        a(".toolbar_button button > svg, .toolbar_button button > img").each(function() {
                            a(this).parent().prepend(this)
                        });
                        var h, k = a("#tools_left");
                        if (k.length !== 0)
                            h = k.offset().top + k.outerHeight();
                        k = a.pref("iconsize");
                        o.setIconSize(k ||
                                (a(window).height() < h ? "s" : "m"));
                        a(".tools_flyout").each(function() {
                            var H = a("#" + this.id + "_show"), F = H.attr("data-curopt");
                ...
                var pb, Mb, ab, Nb, Ab, bb = svgedit.browser.isMac() ?
                        "meta+" : "ctrl+", Wa = c.pathActions, jb = c.undoMgr, Xb = u.imgPath + "logo.png", Y = a("#workarea"), va = a("#cmenu_canvas"), qb = null, Ob = "crosshair", Db = "crosshair", ub = "toolbars", Bb = "", Na = {fill: null, stroke: null};
                (function() {
                    a("#dialog_container").draggable({cancel: "#dialog_content, #dialog_buttons *", containment: "window"});
                    var h = a("#dialog_box"), k = a("#dialog_buttons"), H = a("#dialog_content"), F = function(Q, U, Z, ga, ja, la, ia) {
                        var na, sa, Ha;
                        ...
                        na.click(function() {
                            ...
                            if (Z)
                                Ha ? Z(Ea, Ha.prop("checked")) : Z(Ea)
                        }).focus();
                        if (Q === "prompt" || Q === "select")
                            sa.focus()
                    };
                ...
                var mb = function() {
                    ...
                    c.setMode("select");
                    Y.css("cursor", "auto")
                }, oa = null, Ma = false, ya = false, lb = false, ua = false, db = "", Fb = a("title:first").text(), Sa = [];
                ...
                var Ta = function(h) {
                    var k, H = [], F = c.getCurrentDrawing().getNumLayers();
                    for (k = 0; k < F; k++)
                        H[k] = c.getCurrentDrawing().getLayerName(k);
                    if (h)
                        for (k = 0; k < F; ++k)
                            H[k] != h && c.getCurrentDrawing().setLayerOpacity(H[k],
                                    0.5);
                    else
                        for (k = 0; k < F; ++k)
                            c.getCurrentDrawing().setLayerOpacity(H[k], 1)
                }, Ua = function() {
                    c.clearSelection();
                    for (var h = a("#layerlist tbody").empty(), k = a("#selLayerNames").empty(), H = c.getCurrentDrawing(), F = H.getCurrentLayerName(), Q = c.getCurrentDrawing().getNumLayers(), U = a.getSvgIcon("eye"); Q--; ) {
                        var Z = H.getLayerName(Q), ga = a('<tr class="layer">').toggleClass("layersel", Z === F), ja = a('<td class="layervis">').toggleClass("layerinvis", !H.getLayerVisibility(Z)), la = a('<td class="layername">' + Z + "</td>");
                    ...
                    if (U !== undefined) {
                        ...
                        a.resizeSvgIcons({"td.layervis .svg_icon": 14})
                    }
                    ...
                    for (k = 5 - a("#layerlist tr.layer").size(); k-- > 0; )
                        h.append('<tr><td style="color:white">_</td><td/></tr>')
                }, Ca = function(h, k) {
                    if (!ya) {
                        ya = true;
                        Bb = c.getSvgString();
                    ...
                    if (a(h).hasClass("disabled"))
                        return false;
                    if (a(h).parent().hasClass("tools_flyout"))
                        return true;
                    ...
                    var H = Y.width(), F = Y.height(), Q = H, U = F, Z = c.getZoom(), ga = a("#svgcanvas"), ja = {x: Y[0].scrollLeft + Q / 2, y: Y[0].scrollTop + U / 2}, la = u.canvas_expansion;
                    ...
                    var ia = ga.width() / 2;
                    ga.width(H).height(F);
                    var na = F / 2, sa = H / 2, Ha = c.updateCanvas(H, F), W = sa / ia;
                    H = H / 2 - Q / 2;
                    F = F / 2 - U / 2;
                    if (k) {
                        k.x += Ha.x;
                        ...
                        k = {x: sa + (ja.x - ia) * W, y: na + (ja.y - la) * W};
                    if (h)
                    ...
                    var h, k, H = c.getColor("fill") == "none", F = c.getColor("stroke") == "none", Q = ["#tool_fhpath", "#tool_line"], U = ["#tools_rect .tool_button", "#tools_ellipse .tool_button", "#tool_text", "#tool_path"];
                    if (F)
                        for (h in Q) {
                            k = Q[h];
                    ...
                    c.runExtensions("toolButtonStateUpdate", {nofill: H, nostroke: F});
                    a(".tools_flyout").each(function() {
                        var Z = a("#" + this.id + "_show"), ga = false;
                    ...
                    var h = oa;
                    if (h != null && !h.parentNode)
                        h = null;
                    var k = c.getCurrentDrawing().getCurrentLayerName(), H = c.getMode(), F = u.baseUnit !== "px" ? u.baseUnit : null, Q = H == "pathedit",
                            U = a("#cmenu_canvas li");
                    ...
                    if (h != null) {
                        var Z = h.nodeName, ga = c.getRotationAngle(h);
                        a("#angle").val(ga);
                        var ja = c.getBlur(h);
                        a("#blur").val(ja);
                        ...
                        F = {g: [], a: [], rect: ["rx",
                                "width", "height"], image: ["width", "height"], circle: ["cx", "cy", "r"], ellipse: ["cx", "cy", "rx", "ry"], line: ["x1", "y1", "x2", "y2"], text: [], use: []};
                        var na = h.tagName;
                        Z = null;
                        if (na === "a") {
                            Z = c.getHref(h);
                        ...
                        if (F[na]) {
                            ...
                            a.each(F, function(sa, Ha) {
                                ...
                                if (u.baseUnit !==
                                        "px" && h[Ha])
                                    W = svgedit.units.convertUnit(h[Ha].baseVal.value);
                                a("#" + na + "_" + Ha).val(W || 0)
                            });
                            if (na == "text") {
                        ...
                        U.disableContextMenuItems("#delete,#cut,#copy,#group,#ungroup,#move_front,#move_up,#move_down,#move_back");
                    ...
                    if (k = c.setBBoxZoom(k, Y.width() - 15, Y.height() - 15)) {
                        ...
                        if (h < 0.001)
                            ...
                            H ? eb() : eb(false, {x: k.x * h + k.width * h / 2, y: k.y * h + k.height * h / 2});
                            c.getMode() ==
                                    "zoom" && k.width && mb();
                            Pb()
                        }
                ...
                ab = function(h) {
                    ...
                    if (k < 0.001)
                        ...
                        h = c.getZoom();
                        Ya(window, {width: 0, height: 0, x: (Y[0].scrollLeft + Y.width() / 2) / h, y: (Y[0].scrollTop + Y.height() / 2) / h, zoom: k}, true)
                    }
                };
                ...
                var Ga = {}, ma = function() {
                    ...
                    a(".tools_flyout").each(function() {
                        var h = a("#" + this.id + "_show"), k = h.offset();
                        h = h.outerWidth();
                        a(this).css({left: (k.left + h) * o.tool_scale, top: k.top})
                    })
                }, ra = function(h) {
                    a.each(h, function(k, H) {
                        var F = a(k).children(), Q = k + "_show", U = a(Q), Z = false;
                        F.addClass("tool_button").unbind("click mousedown mouseup").each(function(la) {
                            ...
                            la = function(na) {
                                ...
                                if (na.type ===
                                        "keydown") {
                                    var Ha = a(sa.parent + "_show").hasClass("tool_button_current"), W = a(sa.parent + "_show").attr("data-curopt");
                                    a.each(h[ia.parent], function(xa, Ja) {
                                        if (Ja.sel == W)
                                            sa = !na.shiftKey || !Ha ? Ja : h[ia.parent][xa + 1] || h[ia.parent][0]
                                    })
                                }
                        ...
                        if (Z)
                            U.attr("data-curopt", H[Z].sel);
                        else
                            U.attr("data-curopt") || U.attr("data-curopt", H[0].sel);
                        var ga, ja = a(Q).position();
                        U.mousedown(function(la) {
                            if (U.hasClass("disabled"))
                                return false;
                            var ia = a(k), na = ja.left + 34, sa = ia.width() * -1, Ha = ia.data("shown_popop") ? 200 : 0;
                            ga = setTimeout(function() {
                                U.data("isLibrary") ? ia.css("left", na).show() : ia.css("left", sa).show().animate({left: na}, 150);
                            ...
                            if (U.data("isLibrary") && a(Q.replace("_show", "")).is(":visible"))
                                Oa(Q, true);
                            else
                                Oa(Q) && Ga[la] && Ga[la]()
                        })
                    ...
                    return a("<div>", {"class": "tools_flyout", id: h}).appendTo("#svg_editor").append(k)
                }, Qb = function() {
                    var h, k = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/, H = document.getElementsByTagName("script")[0];
                    for (h in H.style)
                        if (k.test(h))
                            return h.match(k)[0];
                    if ("WebkitOpacity"in H.style)
                        return"Webkit";
                    if ("KhtmlOpacity"in H.style)
                        return"Khtml";
                    return""
                }(), gc = function(h, k) {
                    var H = ["top", "left", "bottom", "right"];
                    h.each(function() {
                        var F, Q = a(this), U = Q.outerWidth() * (k - 1), Z = Q.outerHeight() * (k - 1);
                        for (F = 0; F < 4; F++) {
                            var ga = H[F], ja = Q.data("orig_margin-" + ga);
                            if (ja == null) {
                    ...
                    var k = a("#tools_top .toolset, #editor_panel > *, #history_panel > *,\t\t\t\t#main_button, #tools_left > *, #path_node_panel > *, #multiselected_panel > *,\t\t\t\t#g_panel > *, #tool_font_size > *, .tools_flyout"),
                            H = 1;
                    H = typeof h === "number" ? h : {s: 0.75, m: 1, l: 1.25, xl: 1.5}[h];
                    o.tool_scale = H;
                    La();
                    ...
                    a.pref("iconsize", h);
                    a("#iconsize").val(h);
                    F = {"#tools_top": {left: 50, height: 72}, "#tools_left": {width: 31, top: 74}, "div#workarea": {left: 38, top: 74}};
                    k = a("#tool_size_rules");
                    if (k.length)
                        k.empty();
                    else
                        k = a('<style id="tool_size_rules"></style>').appendTo("head");
                    if (h !== "m") {
                        var Q = "";
                ...
                }, za = [], gb = function(h, k, H) {
                    k = {alpha: k};
                    if (h.indexOf("url(#") === 0) {
                        h = (h = c.getRefElem(h)) ? h.cloneNode(true) : a("#" + H + "_color defs *")[0];
                        k[h.tagName] = h
                    } else
                        k.solidColor = h.indexOf("#") === 0 ? h.substr(1) : "none";
                ...
                c.bind("selected", function(h, k) {
                        ...
                        if (!H) {
                            ...
                            if (oa != null)
                                switch (oa.tagName) {
                                    ...
                                    case "g":
                                    case "a":
                                        var U = null, Z = oa.getElementsByTagName("*");
                                        F = 0;
                    ...
                    rb(H, k);
                    cb();
                    c.runExtensions("selectedChanged", {elems: k, selectedElement: oa, multiselected: Ma})
                });
                c.bind("transition", function(h, k) {
                    var H = c.getMode(), F = k[0];
                    if (F) {
                        Ma = k.length >= 2 && k[1] != null;
                        if (!Ma)
                            switch (H) {
                        ...
                        c.runExtensions("elementTransition", {elems: k})
                    }
                });
                c.bind("changed", function(h, k) {
                    ...
                    for (H = 0; H < k.length; ++H) {
                        ...
                        if (Q &&
                            ...
                            Ua();
                            eb()
                        } else if (Q && oa && oa.parentNode == null)
                            oa = Q
                    }
                    ...
                    c.runExtensions("elementChanged", {elems: k})
                });
                c.bind("saved", function(h, k) {
                    ...
                    if (svgedit.browser.isIE())
                        ...
                        var H = h.open("data:image/svg+xml;base64," + s.encode64(k)), F = a.pref("save_notice_done");
                        if (F !== "all") {
                ...
                c.bind("exported", function(h, k) {
                    var H = k.issues, F = k.type || "PNG", Q = (F === "ICO" ? "BMP" : F).toLowerCase();
                    a("#export_canvas").length || a("<canvas>", {id: "export_canvas"}).hide().appendTo("body");
                    var U = a("#export_canvas")[0];
                    U.width = c.contentW;
                    U.height = c.contentH;
                    canvg(U, k.svg, {renderCallback: function() {
                ...
                c.bind("extension_added", function(h, k) {
                    ...
                    if (k) {
                        var F = false, Q = false, U = true;
                        if (k.langReady)
                            if (o.langChanged) {
                                var Z = a.pref("lang");
                                k.langReady({lang: Z, uiStrings: v})
                            } else
                                za.push(k);
                        var ga = function() {
                            if (k.callback && !F && U) {
                        ...
                        k.context_tools &&
                                a.each(k.context_tools, function(Ha, W) {
                                    var Ea, xa = W.container_id ? ' id="' + W.container_id + '"' : "", Ja = a("#" + W.panel);
                                    Ja.length || (Ja = a("<div>", {id: W.panel}).appendTo("#tools_top"));
                                    switch (W.type) {
                                        case "tool_button":
                                        ...
                                        case "button-select":
                                            ...
                                            ja.push({elem: "#" + W.id, list: "#" + W.id + "_opts", title: W.title, callback: W.events.change,
                                                cur: "#cur_" + W.id});
                                            break;
                                        case "input":
                        ...
                        if (k.buttons) {
                            ...
                            a.each(k.buttons, function(Ha, W) {
                                ...
                                switch (W.type) {
                                    ...
                                    case "context":
                                        Fa = "tool_button";
                                        Ra = "#" + W.panel;
                                        a(Ra).length || a("<div>", {id: W.panel}).appendTo("#tools_top");
                                        break;
                                    case "app_menu":
                                        Fa = "";
                                        Ra = "#main_menu ul"
                                ...
                                if (!W.includeWith &&
                                        !W.list) {
                                    if ("position"in W)
                                        a(Ra).children().eq(W.position).length ? a(Ra).children().eq(W.position).before(Xa) : a(Ra).children().last().before(Xa);
                                    else
                                        Xa.appendTo(Ra);
                                    if (W.type == "mode_flyout") {
                                        ...
                                        if (!Ka.parent().hasClass("tools_flyout")) {
                                            ...
                                            xa = Ka.clone().attr("id", Ja + "_show").append(a("<div>", {"class": "flyout_arrow_horiz"}));
                                            Ka.before(xa);
                                            Fa = Hb(Ja, Ka);
                                        ...
                                        ia["#" + Ja + "_show"] = W.id;
                                        Ja = sa["#" + Fa[0].id] =
                                                [{sel: "#" + Qa, fn: W.events.click, icon: W.id, isDefault: true}, Pa]
                                    } else
                                        W.type == "app_menu" && Xa.append("<div>").append(W.title)
                                } else if (W.list) {
                                    ...
                                    if (Ra.isDefault)
                                        ia["#" + Ja + "_show"] = W.id;
                                    Ja = sa["#" + Fa[0].id] = [{sel: "#" + Qa, fn: W.events.click, icon: W.id, key: W.key, isDefault: W.includeWith ? W.includeWith.isDefault : 0}, Pa];
                                    Qa = "position"in Ra ? Ra.position : "last";
                                    Pa = Fa.children().length;
                                    if (!isNaN(Qa) && Qa >= 0 && Qa < Pa)
                                        Fa.children().eq(Qa).before(Xa);
                                    else {
                                        Fa.append(Xa);
                                        Ja.reverse()
                                    }
                            ...
                            a.each(ja, function() {
                                fb(this.elem, this.list, this.callback, {seticon: true})
                            });
                            if (na)
                                U = false;
                            a.svgIcons(na, {w: 24, h: 24, id_match: false, no_img: !svgedit.browser.isWebkit(), fallback: la, placement: ia, callback: function() {
                                    a.pref("iconsize") !== "m" && H();
                                    U = true;
                                    ga()
                                }})
                ...
                var wb = function(h, k) {
                    ...
                    if (!h ||
                            !h.handle)
                        a("#opac_slider").slider("option", "value", k);
                    c.setOpacity(k / 100)
                }, Tb = function(h, k, H) {
                    if (k == null)
                        k = h.value;
                ...
                a("#selLayerNames").change(function() {
                    var h = this.options[this.selectedIndex].value, k = v.notification.QmoveElemsToLayer.replace("%s", h), H = function(F) {
                        if (F) {
                            Ub = true;
                ...
                a(".attr_changer").change(function() {
                    var h = this.getAttribute("data-attr"), k = this.value;
                    ...
                    if (h !== "id")
                        if (isNaN(k))
                            k = c.convertToNum(h, k);
                        else if (u.baseUnit !== "px") {
                            var H = svgedit.units.getTypeMap();
                            if (oa[h] || c.getMode() === "pathedit" || h === "x" || h === "y")
                                k *= H[u.baseUnit]
                        }
                    if (h ===
                            "id") {
                ...
                a(".palette_item").mousedown(function(h) {
                    ...
                    var k = a(this).data("rgb"), H;
                    if (k === "none" || k === "transparent" || k === "initial") {
                        k = "none";
                        H = new a.jGraduate.Paint
                    } else
                        H = new a.jGraduate.Paint({alpha: 100, solidColor: k.substr(1)});
                    Na[h].setPaint(H);
                    c.setColor(h,
                            k);
                ...
                (function() {
                    var h = null, k = null, H = Y[0], F = false, Q = false;
                ...
                (function() {
                    var h = a("#main_icon"), k = a("#main_icon span"), H = a("#main_menu"),
                            F = false, Q = 0, U = true, Z = false;
                    a(window).mouseup(function(ja) {
                        if (!F) {
                            h.removeClass("buttondown");
                            if (ja.target.tagName != "INPUT")
                                H.fadeOut(200);
                            else if (!Z) {
                                Z = true;
                    ...
                    k.bind("mousedown", function() {
                        if (h.hasClass("buttondown"))
                            H.fadeOut(200);
                        else {
                            H.css("margin-left", 0).show();
                            Q || (Q = H.height());
                            H.css("height", 0).animate({height: Q}, 200);
                            F = true
                        }
                ...
                o.addDropDown = function(h, k, H) {
                    if (a(h).length != 0) {
                        var F = a(h).find("button"), Q = a(h).find("ul").attr("id",
                                a(h)[0].id + "-list"), U = false;
                        ...
                        F.bind("mousedown", function() {
                            if (F.hasClass("down"))
                                ...
                                if (!H) {
                                    var Z = a(h).position();
                                    Q.css({top: Z.top + 24, left: Z.left - 10})
                                }
                                Q.show();
                                U = true
                            }
                ...
                a("#opac_slider").slider({start: function() {
                ...
                var Cb = false;
                a("#blur_slider").slider({max: 10, step: 0.1, stop: function(h, k) {
                        Cb = false;
                        Tb(k);
                ...
                o.addDropDown("#zoom_dropdown", function() {
                    var h = a(this), k = h.data("val");
                    k ? Ya(window, k) : ab({value: parseFloat(h.text())})
                }, true);
                ...
                var Wb = function() {
                    ...
                    if (oa != null || Ma)
                        c.cutSelectedElements()
                }, E = function() {
                    if (oa != null || Ma)
                        c.copySelectedElements()
                }, n = function() {
                    var h = c.getZoom(), k = (Y[0].scrollLeft + Y.width() / 2) / h - c.contentW;
                    ...
                    if (oa != null || Ma)
                        a.prompt(v.notification.enterNewLinkURL, "http://", function(h) {
                            h && c.makeHyperlink(h)
                        })
                }, T = function(h, k) {
                    if (oa != null || Ma) {
                    ...
                    var h = a("#tool_add_subpath"), k = !h.hasClass("push_button_pressed");
                    ...
                    a.select("Select an image type for export: ", ["PNG", "JPEG", "BMP", "WEBP"], function(h) {
                        ...
                        var h = a(this);
                        if (h.val() === "JPEG" || h.val() === "WEBP")
                            a("#image-slider").length || a('<div><label>Quality: <input id="image-slider" type="range" min="1" max="100" value="92" /></label></div>').appendTo(h.parent());
                        else
                            a("#image-slider").parent().remove()
                    })
                }, ba = function() {
                    c.open()
                }, wa = function() {
                ...
                a("#svg_docprops_container, #svg_prefs_container").draggable({cancel: "button,fieldset", containment: "window"});
                var wc = function() {
                    if (!lb) {
                        lb = true;
                        a("#image_save_opts input").val([a.pref("img_save")]);
                    ...
                    if (!ua) {
                        ua = true;
                        a("#main_menu").hide();
                        var h = a("#bg_blocks div"), k = D.bkgd_color, H = a.pref("bkgd_url");
                        h.each(function() {
                            var F = a(this), Q = F.css("background-color") == k;
                    ...
                    h = a("#canvas_width");
                    var k = h.val(), H = a("#canvas_height"), F = H.val();
                    ...
                    eb();
                    pc()
                }, dc = a.noop, qc = function() {
                    a("#dialog_box").hide();
                    if (!ya && !lb && !ua)
                        db && c.leaveContext();
                    else {
                        if (ya)
                            Bb !== a("#svg_source_textarea").val() ? a.confirm(v.notification.QignoreSourceChanges, function(h) {
                                h && ic()
                            }) : ic();
                        else if (lb)
                            oc();
                ...
                }, rc = {width: a(window).width(), height: a(window).height()};
                svgedit.browser.isIE() && function() {
                    dc = function() {
                    ...
                    Ab = {left: Y[0].scrollLeft, top: Y[0].scrollTop};
                    a(window).resize(dc);
                    o.ready(function() {
                        setTimeout(function() {
                            dc()
                ...
                (function() {
                    Y.scroll(function() {
                        if (a("#ruler_x").length !=
                                0)
                            a("#ruler_x")[0].scrollLeft = Y[0].scrollLeft;
                        if (a("#ruler_y").length != 0)
                            a("#ruler_y")[0].scrollTop = Y[0].scrollTop
                    })
                })();
                ...
                (function() {
                    var h = ["clear", "open", "save", "source", "delete", "delete_multi", "paste", "clone", "clone_multi", "move_top", "move_bottom"], k = "";
                ...
                if (svgedit.browser.isMac() && !window.opera) {
                    ...
                    for (ta = ec.length; ta--; ) {
                        ...
                        if (jc) {
                            var kc = jc.title, sc = kc.indexOf("Ctrl+");
                ...
                var tc =
                        function(h) {
                            var k = h.attr("id") == "stroke_color" ? "stroke" : "fill", H = Na[k].paint, F = k == "stroke" ? "Pick a Stroke Paint and Opacity" : "Pick a Fill Paint and Opacity";
                            h = h.offset();
                            a("#color_picker").draggable({cancel: ".jGraduate_tabs, .jGraduate_colPick, .jGraduate_gradPick, .jPicker", containment: "window"}).css(u.colorPickerCSS || {left: h.left - 140, bottom: 40}).jGraduate({paint: H, window: {pickerTitle: F}, images: {clientPath: u.jGraduatePath}, newstop: "inverse"}, function(Q) {
                ...
                ta = function(h, k) {
                    var H, F, Q = u[k === "fill" ? "initFill" : "initStroke"], U = (new DOMParser).parseFromString('<svg xmlns="http://www.w3.org/2000/svg"><rect width="16.5" height="16.5"\t\t\t\t\tfill="#' + Q.color + '" opacity="' + Q.opacity + '"/>\t\t\t\t\t<defs><linearGradient id="gradbox_"/></defs></svg>', "text/xml").documentElement;
                    ...
                    this.paint = new a.jGraduate.Paint({solidColor: Q.color});
                    this.type = k;
                    this.setPaint = function(Z, ga) {
                        this.paint = Z;
                        var ja = "none", la = Z.type, ia = Z.alpha / 100;
                        switch (la) {
                            case "solidColor":
                    ...
                    this.update = function(Z) {
                        if (oa) {
                            ...
                            switch (oa.tagName) {
                                ...
                                case "g":
                                case "a":
                                    var ia = null, na = oa.getElementsByTagName("*");
                                    ga = 0;
                    ...
                    this.prep = function() {
                        switch (this.paint.type) {
                            case "linearGradient":
                            case "radialGradient":
                                var Z = new a.jGraduate.Paint({copy: this.paint});
                                c.setPaint(k, Z)
                            }
                    }
                };
                ...
                a(ta).remove();
                (function() {
                    var h = "-" + Qb.toLowerCase() + "-zoom-", k = h + "in";
                    Y.css("cursor", k);
                    if (Y.css("cursor") === k) {
                        Ob = k;
                        Db = h + "out"
                ...
                a("#layer_new").click(function() {
                    ...
                    do
                        h = v.layers.layer + " " + ++k;
                    while (c.getCurrentDrawing().hasLayer(h));
                    a.prompt(v.notification.enterUniqueLayerName, h, function(H) {
                        if (H)
                            if (c.getCurrentDrawing().hasLayer(H))
                                a.alert(v.notification.dupeLayerName);
                            else {
                                c.createLayer(H);
                                cb();
                ...
                a("#layer_rename").click(function() {
                    ...
                    a.prompt(v.notification.enterNewLayerName, "", function(k) {
                        if (k)
                            if (h == k || c.getCurrentDrawing().hasLayer(k))
                                a.alert(v.notification.layerHasThatName);
                            else {
                ...
                var Vb = -1, fc = false, lc = false, uc = function(h) {
                    var k = a("#ruler_x");
                ...
                a("#resolution").change(function() {
                    ...
                    if (this.selectedIndex)
                        if (this.value == "content")
                            h.val("fit").attr("disabled", "disabled");
                        else {
                        ...
                        a("#canvas_width").val() == "fit" && h.removeAttr("disabled").val(100)
                });
                a("input,select").attr("autocomplete", "off");
                Nb = function() {
                    var h = [{sel: "#tool_select", fn: Eb, evt: "click", key: ["V", true]}, {sel: "#tool_fhpath", fn: Wb, evt: "click", key: ["Q", true]}, {sel: "#tool_line",
                            fn: Zb, evt: "click", key: ["L", true]}, {sel: "#tool_rect", fn: Sb, evt: "mouseup", key: ["R", true], parent: "#tools_rect", icon: "rect"}, {sel: "#tool_square", fn: yb, evt: "mouseup", parent: "#tools_rect", icon: "square"}, {sel: "#tool_fhrect", fn: hc, evt: "mouseup", parent: "#tools_rect", icon: "fh_rect"}, {sel: "#tool_ellipse", fn: ac, evt: "mouseup", key: ["E", true], parent: "#tools_ellipse", icon: "ellipse"}, {sel: "#tool_circle", fn: xb, evt: "mouseup", parent: "#tools_ellipse", icon: "circle"}, {sel: "#tool_fhellipse", fn: $b, evt: "mouseup", parent: "#tools_ellipse",
                            icon: "fh_ellipse"}, {sel: "#tool_path", fn: d, evt: "click", key: ["P", true]}, {sel: "#tool_text", fn: f, evt: "click", key: ["T", true]}, {sel: "#tool_image", fn: zb, evt: "mouseup"}, {sel: "#tool_zoom", fn: Va, evt: "mouseup", key: ["Z", true]}, {sel: "#tool_clear", fn: aa, evt: "mouseup", key: ["N", true]}, {sel: "#tool_save", fn: function() {
                                if (ya)
                                    nc();
                                else {
                                    var H = {images: a.pref("img_save"), round_digits: 6};
                                    c.save(H)
                                }
                            }, evt: "mouseup", key: ["S", true]}, {sel: "#tool_export", fn: Aa, evt: "mouseup"}, {sel: "#tool_open", fn: ba, evt: "mouseup", key: ["O", true]},
                        {sel: "#tool_import", fn: wa, evt: "mouseup"}, {sel: "#tool_source", fn: Ca, evt: "click", key: ["U", true]}, {sel: "#tool_wireframe", fn: Kb, evt: "click", key: ["F", true]}, {sel: "#tool_source_cancel,.overlay,#tool_docprops_cancel,#tool_prefs_cancel", fn: qc, evt: "click", key: ["esc", false, false], hidekey: true}, {sel: "#tool_source_save", fn: nc, evt: "click"}, {sel: "#tool_docprops_save", fn: yc, evt: "click"}, {sel: "#tool_docprops", fn: wc, evt: "mouseup"}, {sel: "#tool_prefs_save", fn: zc, evt: "click"}, {sel: "#tool_prefs_option", fn: function() {
                                xc();
                                return false
                            }, evt: "mouseup"}, {sel: "#tool_delete,#tool_delete_multi", fn: r, evt: "click", key: ["del/backspace", true]}, {sel: "#tool_reorient", fn: C, evt: "click"}, {sel: "#tool_node_link", fn: V, evt: "click"}, {sel: "#tool_node_clone", fn: X, evt: "click"}, {sel: "#tool_node_delete", fn: ca, evt: "click"}, {sel: "#tool_openclose_path", fn: M, evt: "click"}, {sel: "#tool_add_subpath", fn: S, evt: "click"}, {sel: "#tool_move_top", fn: z, evt: "click", key: "ctrl+shift+]"}, {sel: "#tool_move_bottom", fn: B, evt: "click", key: "ctrl+shift+["}, {sel: "#tool_topath",
                            fn: K, evt: "click"}, {sel: "#tool_make_link,#tool_make_link_multi", fn: O, evt: "click"}, {sel: "#tool_undo", fn: Da, evt: "click", key: ["Z", true]}, {sel: "#tool_redo", fn: $a, evt: "click", key: ["Y", true]}, {sel: "#tool_clone,#tool_clone_multi", fn: Jb, evt: "click", key: ["D", true]}, {sel: "#tool_group_elements", fn: hb, evt: "click", key: ["G", true]}, {sel: "#tool_ungroup", fn: hb, evt: "click"}, {sel: "#tool_unlink_use", fn: hb, evt: "click"}, {sel: "[id^=tool_align]", fn: Rb, evt: "click"}, {sel: "#tool_bold", fn: ha, evt: "mousedown"}, {sel: "#tool_italic",
                            fn: pa, evt: "mousedown"}, {sel: "#sidepanel_handle", fn: mc, key: ["X"]}, {sel: "#copy_save_done", fn: qc, evt: "click"}, {key: "ctrl+left", fn: function() {
                                P(0, 1)
                                ...
                                P(1, 5)
                            }}, {key: "shift+O", fn: N}, {key: "shift+P", fn: J}, {key: [bb + "up", true], fn: function() {
                                tb(2)
                            }}, {key: [bb + "down", true], fn: function() {
                                tb(0.5)
                            }}, {key: [bb + "]", true], fn: function() {
                                G("Up")
                            }}, {key: [bb + "[", true], fn: function() {
                                G("Down")
                            }}, {key: ["up",
                            ...
                            }}, {key: bb + "z", fn: Da}, {key: bb + "shift+z", fn: $a}, {key: bb + "y", fn: $a}, {key: bb + "x",
                            fn: j}, {key: bb + "c", fn: E}, {key: bb + "v", fn: n}], k = {"4/Shift+4": "#tools_rect_show", "5/Shift+5": "#tools_ellipse_show"};
                    return{setAll: function() {
                            var H = {};
                            a.each(h, function(F, Q) {
                                ...
                                if (Q.sel) {
                                    ...
                                    if (U.length == 0)
                                        return true;
                                    if (Q.evt) {
                                        if (svgedit.browser.isTouch() && Q.evt === "click")
                                            Q.evt = "mousedown";
                                        U[Q.evt](Q.fn)
                                    }
                ...
                Nb.setAll();
                o.ready(function() {
                    var h = u.initTool, k = a("#tools_left, #svg_editor .tools_flyout"), H = k.find("#tool_" + h);
                    h = k.find("#" + h);
                    ...
                    a("#rulers").toggle(!!u.showRulers);
                    if (u.showRulers)
                        a("#show_rulers")[0].checked = true;
                    u.baseUnit && a("#base_unit").val(u.baseUnit);
                    if (u.gridSnapping)
                        a("#grid_snapping_on")[0].checked = true;
                    u.snappingStep && a("#grid_snapping_step").val(u.snappingStep);
                    u.gridColor && a("#grid_color").val(u.gridColor)
                });
                a("#rect_rx").SpinButton({min: 0, max: 1E3, callback: function(h) {
                        c.setRectRadius(h.value)
                    }});
                a("#stroke_width").SpinButton({min: 0, max: 99, smallStep: 0.1, callback: function(h) {
                        var k = h.value;
                        if (k == 0 && oa && ["line", "polyline"].indexOf(oa.nodeName) >= 0)
                            k = h.value = 1;
                        c.setStrokeWidth(k)
                    }});
                a("#angle").SpinButton({min: -180, max: 180, step: 5, callback: function(h) {
                        c.setRotationAngle(h.value);
                        a("#tool_reorient").toggleClass("disabled", parseInt(h.value, 10) === 0)
                    }});
                a("#font_size").SpinButton({min: 0.001, stepfunc: function(h, k) {
                        var H = Number(h.value), F = H + k, Q = F >= H;
                        if (k === 0)
                            return H;
                        if (H >= 24) {
                            if (Q)
                ...
                a("#group_opacity").SpinButton({min: 0, max: 100, step: 5, callback: wb});
                a("#blur").SpinButton({min: 0, max: 10, step: 0.1, callback: Tb});
                a("#zoom").SpinButton({min: 0.001,
                    max: 1E4, step: 50, stepfunc: function(h, k) {
                        ...
                        if (F >= H)
                            return H * 2;
                        return H / 2
                    }, callback: ab}).val(c.getZoom() * 100);
                a("#workarea").contextMenu({menu: "cmenu_canvas", inSpeed: 0}, function(h) {
                    switch (h) {
                        case "delete":
                            r();
                            break;
                ...
                a("#layerlist").contextMenu({menu: "cmenu_layers", inSpeed: 0}, ta);
                a("#layer_moreopts").contextMenu({menu: "cmenu_layers", inSpeed: 0, allowLeft: true}, ta);
                ...
                window.addEventListener("beforeunload", function(h) {
                    if (jb.getUndoStackSize() === 0)
                        o.showSaveWarning = false;
                    if (!u.no_save_warning && o.showSaveWarning)
                        ...
                        if (h = h.type == "drop" ? h.dataTransfer.files[0] : this.files[0])
                            if (h.type.indexOf("image") != -1) {
                                ...
                                if (h.type.indexOf("svg") != -1) {
                                    ...
                                    k = new FileReader;
                                    k.onloadend = function(H) {
                                        var F = 100, Q = 100, U = new Image;
                                        U.src = H.target.result;
                                        U.style.opacity = 0;
                                        U.onload = function() {
                                            F = U.offsetWidth;
                                            Q = U.offsetHeight;
                                            var Z = c.addSvgElementFromJson({element: "image", attr: {x: 0, y: 0, width: F, height: Q, id: c.getNextId(), style: "pointer-events:inherit"}});
                ...
                o.setLang = function(h, k) {
                    ...
                    if (k) {
                        ...
                        if (za.length)
                            for (; za.length; )
                                za.shift().langReady({lang: h,
                                    uiStrings: v});
                        else
                            c.runExtensions("langReady", {lang: h, uiStrings: v});
                        c.runExtensions("langChanged", h);
                        ma();
                        a.each({"#stroke_color": "#tool_stroke .icon_label, #tool_stroke .color_block", "#fill_color": "#tool_fill label, #tool_fill .color_block", "#linejoin_miter": "#cur_linejoin", "#linecap_butt": "#cur_linecap"}, function(F, Q) {
            ...
            o.loadFromURL = function(t, m) {
                m || (m = {});
                var L = m.cache, R = m.callback;
                o.ready(function() {
                    a.ajax({url: t, dataType: "text", cache: !!L, beforeSend: function() {
                            a.process_cancel(v.notification.loadingImage)
                        }, success: function(da) {
                            I(da, R)
...
var svgEditor = function(a, I) {
    ...
    I.readLang = function(i) {
        ...
        if (i.tools) {
            var e = i.tools;
            s = i.properties;
            var g = i.config, q = i.layers, w = i.common, D = i.ui;
            o("content", {curve_segments: s.curve_segments, fitToContent: e.fitToContent, fit_to_all: e.fit_to_all, fit_to_canvas: e.fit_to_canvas, fit_to_layer_content: e.fit_to_layer_content, fit_to_sel: e.fit_to_sel, icon_large: g.icon_large, icon_medium: g.icon_medium, icon_small: g.icon_small, icon_xlarge: g.icon_xlarge, image_opt_embed: g.image_opt_embed, image_opt_ref: g.image_opt_ref, includedImages: g.included_images, largest_object: e.largest_object,
                layersLabel: q.layers, page: e.page, relativeToLabel: e.relativeTo, selLayerLabel: q.move_elems_to, selectedPredefined: g.select_predefined, selected_objects: e.selected_objects, smallest_object: e.smallest_object, straight_segments: s.straight_segments, svginfo_bg_url: g.editor_img_url + ":", svginfo_bg_note: g.editor_bg_note, svginfo_change_background: g.background, svginfo_dim: g.doc_dims, svginfo_editor_prefs: g.editor_prefs, svginfo_height: w.height, svginfo_icons: g.icon_size, svginfo_image_props: g.image_props, svginfo_lang: g.language,
                svginfo_title: g.doc_title, svginfo_width: w.width, tool_docprops_cancel: w.cancel, tool_docprops_save: w.ok, tool_source_cancel: w.cancel, tool_source_save: w.ok, tool_prefs_cancel: w.cancel, tool_prefs_save: w.ok, sidepanel_handle: q.layers.split("").join(" "), tool_clear: e.new_doc, tool_docprops: e.docprops, tool_export: e.export_img, tool_import: e.import_doc, tool_imagelib: e.imagelib, tool_open: e.open_doc, tool_save: e.save_doc, svginfo_units_rulers: g.units_and_rulers, svginfo_rulers_onoff: g.show_rulers, svginfo_unit: g.base_unit,
                svginfo_grid_settings: g.grid, svginfo_snap_onoff: g.snapping_onoff, svginfo_snap_step: g.snapping_stepsize, svginfo_grid_color: g.grid_color}, true);
            var u, A = {};
            for (u in i.shape_cats)
                A['#shape_cats [data-cat="' + u + '"]'] = i.shape_cats[u];
            setTimeout(function() {
                o("content", A)
            }, 2E3);
            var p = {};
            ...
            o("content", p);
            o("title", {align_relative_to: e.align_relative_to, circle_cx: s.circle_cx, circle_cy: s.circle_cy, circle_r: s.circle_r, cornerRadiusLabel: s.corner_radius, ellipse_cx: s.ellipse_cx, ellipse_cy: s.ellipse_cy, ellipse_rx: s.ellipse_rx, ellipse_ry: s.ellipse_ry, fill_color: s.fill_color, font_family: s.font_family, idLabel: s.id, image_height: s.image_height, image_url: s.image_url, image_width: s.image_width, layer_delete: q.del,
                layer_down: q.move_down, layer_new: q["new"], layer_rename: q.rename, layer_moreopts: w.more_opts, layer_up: q.move_up, line_x1: s.line_x1, line_x2: s.line_x2, line_y1: s.line_y1, line_y2: s.line_y2, linecap_butt: s.linecap_butt, linecap_round: s.linecap_round, linecap_square: s.linecap_square, linejoin_bevel: s.linejoin_bevel, linejoin_miter: s.linejoin_miter, linejoin_round: s.linejoin_round, main_icon: e.main_menu, mode_connect: e.mode_connect, tools_shapelib_show: e.mode_shapelib, palette: D.palette_info, zoom_panel: D.zoom_level,
                path_node_x: s.node_x, path_node_y: s.node_y, rect_height_tool: s.rect_height, rect_width_tool: s.rect_width, seg_type: s.seg_type, selLayerNames: q.move_selected, selected_x: s.pos_x, selected_y: s.pos_y, stroke_color: s.stroke_color, stroke_style: s.stroke_style, stroke_width: s.stroke_width, svginfo_title: g.doc_title, text: s.text_contents, toggle_stroke_tools: D.toggle_stroke_tools, tool_add_subpath: e.add_subpath, tool_alignbottom: e.align_bottom, tool_aligncenter: e.align_center, tool_alignleft: e.align_left, tool_alignmiddle: e.align_middle,
                tool_alignright: e.align_right, tool_aligntop: e.align_top, tool_angle: s.angle, tool_blur: s.blur, tool_bold: s.bold, tool_circle: e.mode_circle, tool_clone: e.clone, tool_clone_multi: e.clone, tool_delete: e.del, tool_delete_multi: e.del, tool_ellipse: e.mode_ellipse, tool_eyedropper: e.mode_eyedropper, tool_fhellipse: e.mode_fhellipse, tool_fhpath: e.mode_fhpath, tool_fhrect: e.mode_fhrect, tool_font_size: s.font_size, tool_group_elements: e.group_elements, tool_make_link: e.make_link, tool_link_url: e.set_link_url, tool_image: e.mode_image,
                tool_italic: s.italic, tool_line: e.mode_line, tool_move_bottom: e.move_bottom, tool_move_top: e.move_top, tool_node_clone: e.node_clone, tool_node_delete: e.node_delete, tool_node_link: e.node_link, tool_opacity: s.opacity, tool_openclose_path: e.openclose_path, tool_path: e.mode_path, tool_position: e.align_to_page, tool_rect: e.mode_rect, tool_redo: e.redo, tool_reorient: e.reorient_path, tool_select: e.mode_select, tool_source: e.source_save, tool_square: e.mode_square, tool_text: e.mode_text, tool_topath: e.to_path, tool_undo: e.undo,
                tool_ungroup: e.ungroup, tool_wireframe: e.wireframe_mode, view_grid: e.toggle_grid, tool_zoom: e.mode_zoom, url_notice: e.no_embed}, true);
            I.setLang(c, i)
        }
    };
...
(function() {
    ...
    svgedit.contextmenu.add = function(I) {
        if (I && I.id && I.label && I.action && typeof I.action == "function")
            if (I.id in a.contextMenuExtensions)
                console.error('Cannot add extension "' + I.id + '", an extension by that name already exists"');
            else {
